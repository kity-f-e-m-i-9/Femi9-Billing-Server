...
$tempID2="".$randum_number2."/STR/".$temp_date2."".$temp_time2."";?>
	...
	<input type="hidden" name="tousertype" value="<?=$result_LoGuserDtails['onboard_userTYPE'];?>">
	<input type="hidden" name="touserid" value="<?=$result_LoGuserDtails['onboard_userID'];?>">
...
<?php
$onboardusertypeGET=$result_LoGuserDtails['onboard_userTYPE'];
if($onboardusertypeGET=="company"){?>
<?php /*?>
...
<?php }else{?>
<input type="hidden" name="reqtype" value="Nil"/>
<input type="hidden" name="screenshot" value="Nil"/>
<input type="hidden" name="screenshot2" value="Nil"/>
<input type="hidden" name="amount" value="0"/>
<input type="hidden" name="utr" value="Nil"/>
<?php } ?>
