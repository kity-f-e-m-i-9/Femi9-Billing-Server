...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
	...
	{
		$addurl="user-invoice-add.php?alreadyexists";
		$viewurl="user-invoice-add.php?addesuccess";
	}else{
...
$fetc_count_dist=mysqli_query($db_conn,$select_count_dist);
	...
	$useridtext="FEMI9-R-".$format_num."";
		...
		'$merchantTransactionId','$account_status',
		'$merchantOrderId','$merchantTransactionId','$merchantUserId',
		'$taluk_id','$distributor_id','$pincode_id','$gstin','$onboard_userTYPE',
		'$onboard_userID','$address','$userid','$useridtext','$shop_cat','$country_code','$landline')";
