...
<input type="hidden" name="stockiest_id" value="<?php echo $loguser_tempid;?>"/>
...
xmlhttp.send();}
                                                ...
                                                <select required="" name="dist_id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onchange="showtaluk(this.value)">
												<option value="" hidden="">Select</option>
									<?php $select_product_list="select * from district order by dist_name asc";
										...
										<?php }?>
												...
												<label for="exampleInputEmail1" class="form-label">Taluk Name</label><div id="txtHinttaluk">
   ...
   <br/>
				...
				<button type="button" class="btn btn-primary btn-burger" onClick="addRow('dataTable')"><i class="material-icons">add</i></button>     
				 ...
				 <table id="dataTable" border="0">
                    <tr>
						<td>
					<input class="form-check-input" type="checkbox" name="chk[]"/></td>
						 <td>
							<input type="text" name="pincode[]" required="required" placeholder="Pincode" class="form-control"/>
					     </td>
                    </tr>
                </table>
