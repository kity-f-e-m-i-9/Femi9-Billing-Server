...
try {
    ...
    echo "<script>console.log('STOCK UPDATE PROCESS COMPLETED SUCCESSFULLY: $items_processed');</script>";
    ...
    echo "<script>console.log('Stock update failed: $e->getMessage()');</script>";
}
