...
<table id="datatable1">
											...
											<tbody> 
<?php $select_product_list="select * from super_distributor where onboard_userTYPE='$onboard_userTYPE' and onboard_userID='$onboard_userID' AND account_status = 'active' order by id desc";
