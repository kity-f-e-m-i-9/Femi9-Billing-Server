...
if (isset($_SESSION['LOGIN_USER_TYPE']) && $_SESSION['LOGIN_USER_TYPE'] !== 'super_stockiest') {
    session_unset();
    session_destroy();
    header('Location: ../login/index.php');
    exit;
...
$Login_user_TYPEvl = $_SESSION['LOGIN_USER_TYPE'] ?? 'super_stockiest';

// Fetch user details
$select_LoGuserDtails = "SELECT * FROM super_stockiest WHERE mobile_number = ? LIMIT 1";
