...
<label class="form-label"><b>Payent Screenshot(1):-</b></label><br/>
<?=$imgshow;?>
</br>
</div>
<?php } ?>
...
<?php /*?>
<?php 
if($result_reqdetaiis['screenshot3']!="Nil"){
$imgshow="<img src='screenshot/".$result_reqdetaiis['screenshot3']."' style='width:300px;'>";
?>
<div style="margin-top:10px;">
<label class="form-label"><b>Payent Screenshot(3):-</b></label><br/>
<?=$imgshow;?>
</br>
</div>
<?php } ?>
...
<?php 
if($result_reqdetaiis['screenshot4']!="Nil"){
$imgshow="<img src='screenshot/".$result_reqdetaiis['screenshot4']."' style='width:300px;'>";
?>
<div style="margin-top:10px;">
<label class="form-label"><b>Payent Screenshot(4):-</b></label><br/>
<?=$imgshow;?>
</br>
</div>
<?php } ?>
...
<?php 
if($result_reqdetaiis['screenshot5']!="Nil"){
$imgshow="<img src='screenshot/".$result_reqdetaiis['screenshot5']."' style='width:300px;'>";
?>
<div style="margin-top:10px;">
<label class="form-label"><b>Payent Screenshot(5):-</b></label><br/>
<?=$imgshow;?>
</br>
</div>
<?php } ?>
...
<?php if($result_reqdetaiis['utr']!=NULL){?>
<div style="margin-top:10px;">
