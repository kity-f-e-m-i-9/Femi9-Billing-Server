                                ...
                                <div class="card">
									...
									<div id="overflowon">
                                        <table id="datatable1" class="display" style="width:100%;">
											...
											<tbody>
										<?php $select_product_list="select * from invoice where user_type='$Login_user_TYPEvl' and user_id='$Login_user_IDvl' order by id desc";
...
<?php }?>
													...
													<td>
<a href="customer-user-invoice-add.php?invuser=<?=$getinvuser;?>&&InvoiceID=<?php echo $INVID_encode;?>&&action=edit" title="Edit"><img src="../../assets/images/edit-32.png"/></a>
													</td>
...
<td>
													<?php if($result_product_list["sub_total"]==0){?>
<a href="delinvoice?invtype=customer&&invuser=<?=$getinvuser;?>&&invid=<?=$INVID_encode;?>"onclick="return confirm('You want to delete confirm?');" title="Delete">
