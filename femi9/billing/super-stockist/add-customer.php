<?php include("checksession.php"); header("Location: dashboard.php"); exit; date_default_timezone_set("Asia/Kolkata");?>
<!DOCTYPE html>
<html lang="en">
...
<input type="text" name="gstin" class="form-control" placeholder="optional" onkeypress="restrictGSTIN(event)">
</br>

<label class="form-label">Address</label>
<textarea name="address" class="form-control" placeholder="optional" onkeypress="restrictSpecialChars(event)"></textarea>
</br>
