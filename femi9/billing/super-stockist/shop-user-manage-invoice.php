										...
										$Cust_Mbile=$result_Customers['mobile_number'];
											...
											?>
                                                ...
                                                <tr>
													...
													<td>
													<a href="#" id="linkcaption" data-bs-toggle="modal" data-bs-target="#exampleModalLive<?php echo $result_product_list["id"];?>">
													<?php echo $result_product_list["inv_number"];?></a>
													</td>
...
<?php }?>
													...
													<td>
<a href="shop-user-invoice-add.php?invuser=<?=$getinvuser;?>&&action=edit&&InvoiceID=<?=$INVID_encode;?>" title="Edit"><img src="../../assets/images/edit-32.png"/></a>
													</td>
...
<td>
													<?php if($result_product_list["sub_total"]==0){?>
<a href="delinvoice?invtype=shop&&invuser=<?=$getinvuser;?>&&invid=<?=$INVID_encode;?>"onclick="return confirm('You want to delete confirm?');" title="Delete">
