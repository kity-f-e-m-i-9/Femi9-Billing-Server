...
var DistrictID="<?php echo $loguser_DistrictID;?>";
		var strURL="loadpincodeshop.php?subcourseID="+courseId+"&StateID="+StateID+"&DistrictID="+DistrictID;
		var req = getXMLHTTP();
		if (req) {
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
...
<option value="" hidden="">Select</option>
<?php $select_Taluk_list="select * from taluk where state_id='$loguser_StateID' and dist_id='$loguser_DistrictID' order by taluk asc";
