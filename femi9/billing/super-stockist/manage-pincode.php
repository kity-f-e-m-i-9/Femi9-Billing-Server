<?php include("checksession.php"); include("config.php");

$title="Manage Pincode";
$add_url="add-pincode.php";
                                    ...
                                    <div class="card-body" style="overflow:scroll !important;">
                                        <table id="datatable1" class="display" style="width:100%">
                                            <thead>
											 ...
											 <tbody>
	<?php 
	$select_picnode_list="select * from pincode where usertype='$Login_user_TYPEvl' and userid='$Login_user_IDvl' order by id asc";
										...
										$talulk_name=$result_taluk['taluk'];
											...
											?>
                                                <tr>
													...
													<td>
													<a href="edit-pincode.php?prid=<?php echo $row_id;?>"><img src="../../assets/images/edit-32.png"/></a>
													</td>
													<!-----<td>
													<a href="delete-pincode.php?prid=<?php echo $row_id;?>"onclick="return confirm('You want to delete confirm?');"><img src="../../assets/images/delete-32.png"/></a>
													</td>---->
                                                </tr>
										<?php }?>
										</tbody>
