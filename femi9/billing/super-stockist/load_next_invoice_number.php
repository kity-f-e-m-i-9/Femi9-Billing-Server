...
// Auto-suggest for super stockist's network channel invoices (user_invoice
// table, scoped to this logged-in account) — one prefix per downstream
// channel (?invuser=), napkin vs diaper decided by whichever product type is
// added FIRST to the invoice (see InvoiceNumberSuggest.php). ?pid= is the
