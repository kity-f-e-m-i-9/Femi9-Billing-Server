...
<head>
    ...
    <!-- Title -->
    <title>Manage coupon : <?php echo $business_name;?></title>
                                ...
                                <div class="card">
									...
									<div style="overflow-x:scroll;">
                                         <table id="datatable1">
											...
											<tbody>
					<?php $select_product_list="select * from coupons where stock_user_tempid='$loguser_tempid' and user_type='super_stockiest' order by id desc";
										...
										while($result_product_list=mysqli_fetch_array($fetch_product_list))
										{
											...
											?>
                                                ...
                                                <tr>
                                                    <td><?php echo ++$i; ?></td>
													<td><?php echo $result_product_list["category"];?></td>
