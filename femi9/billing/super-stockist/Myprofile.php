...
//---------------------------------------------------------------------------------------
//user details
$select_userdetails234="select * from super_stockiest where temp_id='$Login_user_IDvl'";
...
if(isset($_REQUEST['updateprofile']))
{
	...
	$deliveryaddress=str_replace("'","&#39;",$_REQUEST['deliveryaddress']);
...
if($filetype12 != 'image/jpeg' && $filetype12 != 'image/jpg' && $filetype12 != 'image/png')
{
 ...
 echo "<script>window.location='Myprofile.php?uploadError';</script>";
	   ...
	   if($_REQUEST['onboar_usertype']=="candf")
	   {
           $uploaddir='../c-and-f/user_icon/';
	   }else{
		   $uploaddir='../company/user_icon/';
	   }
	   ...
	   unlink("../company/".$old_user_icon."");
	   
}

	}else{$insfilename=$old_user_icon;}
	
	$updateusers="update super_stockiest set user_icon='$insfilename',name='$name',email='$email',gstin='$gstin',address='$address' where temp_id='$user_tempid'";
...
<input type="hidden" name="onboar_usertype" value="<?=$result_userdetails234['onboard_userTYPE'];?>">
			...
			<?php if($result_userdetails234['onboard_userTYPE']=="candf"){?>
			<img src="../c-and-f/<?=$result_userdetails234['user_icon'];?>" style="width:150px;margin-bottom:10px;margin-top:10px;"/>
			<?php }else{?>
			<img src="../company/<?=$result_userdetails234['user_icon'];?>" style="width:150px;margin-bottom:10px;margin-top:10px;"/>
			<?php }?>
            ...
            <input type="email" onkeypress="restrictemail(event)" required="" value="<?=$result_userdetails234['email'];?>" name="email" class="form-control">
			<br/>
            ...
            <input type="text" required="" onkeypress="restrictSpecialChars(event)" name="acname" value="<?=$resultcountprofileDetails['acname'];?>" class="form-control"><br/>
            ...
            <input type="text" required="" onkeypress="restrictSpecialChars(event)" name="upinumber" value="<?=$resultcountprofileDetails['upinumber'];?>" class="form-control"><br/>
			<br/>
