...
<head>
    ...
    <!-- Title -->
    <title>Stock Return Rejeceted : <?php echo $business_name;?></title>
                                ...
                                <div class="card">
									...
									<div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
					<?php $select_product_list="select * from user_return_stock where to_usertype='$Login_user_TYPEvl' and to_userid='$Login_user_IDvl' and status='reject' order by id desc";
...
<td><?=inr_format($totalamount, 2);?></td>						
													...
													<td>
			<a href="stock_return_details.php?returnid=<?=base64_encode($returnid);?>&&pagename=stock_return_rejected" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
