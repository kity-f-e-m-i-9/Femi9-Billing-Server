<?php
/**
 * Get Advance Payment Edit Form (Super Stockist)
 * Femi9 Billing Application
 *
 * Mirrors company/get-advance-payment-edit-form.php, scoped so a super
 * stockist can only load the edit form for payments where they are the
 * receiver — otherwise any logged-in super stockist could edit any
 * payment system-wide just by guessing/incrementing the id.
 */
