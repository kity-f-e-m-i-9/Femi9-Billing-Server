...
$select_records = "select * from user_invoice where date between '$from_date' and '$to_date' and from_user_type='$Login_user_TYPEvl' and sub_total>0 and from_user_id='$Login_user_IDvl' order by id asc";
