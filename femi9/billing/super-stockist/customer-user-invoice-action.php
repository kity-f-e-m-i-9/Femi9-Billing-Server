...
//--------------------------------------------------------------------------------
	...
	if($result_count_invoice['numInvoice']==0)
	{
		...
		*/
		...
		//2. insert invoice
		$insert_Invoice="insert into invoice (inv_id,id_only,inv_number,customer_id,date,inv_year,sub_total,discount,total,user_type,user_id,gst_type,roundoff,courier_charges,buyer_gsttype)
		values 
	...
	if($result_count_invoiceItem['numInvoiceItem']==0)
	{
		...
		rwpoints,rwpoints_sls)
		values ('$inv_id','$pr_id','$amount','$qty','$total','$Login_user_TYPEvl','$Login_user_IDvl',
		'$customer_id','$gst_percentage','$gstamount_singlepr','$gstamount_total','$subtotal',
		'$discount_percentage','$discount_amount','$gst_type','$hsn','$date','$buyer_gsttype',
		'$rwpoints','$rwpoints')";
