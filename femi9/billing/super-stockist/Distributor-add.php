...
<form action="Distributor-action.php" method="post" enctype="multipart/form-data" id="uploadForm">
...
<input type="hidden" name="password" value="12345678">
	...
	<option value="<?php echo $result_stcatlist['amount'];?>"><?php echo $result_stcatlist['amount'];?></option>
            ...
            <input type="file" name="user_icon" required="" class="form-control" id="fileUpload" accept=".jpg, .jpeg, .png">
	<br/>
