...
<head>
    ...
    <!-- Title -->
    <title><?php echo ucwords($result_product_list['name']);?> : Distributor</title>
...
<body>
 ...
 <tr>
                    <th colspan="2"><img src="../stockist/<?php echo $result_product_list["user_icon"];?>" style="width:150px;border-radius:10px;"></th>
                    </tr>
 <?php } ?>
