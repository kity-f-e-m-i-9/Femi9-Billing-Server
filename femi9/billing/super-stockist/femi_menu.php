...
<?php 
$select_LoGuserDtailsMN="select * from super_stockiest where username='".$_SESSION['LOGIN_USER']."'";
...
<ul class="accordion-menu">
			...
			<li><a href="#"><i class="material-icons-two-tone">view_agenda</i>Report</a> </li>
			
			<li><a href="wallet-history"><i class="material-icons-outlined">wallet</i>Wallet History</a></li>
...
<?php }else{?>
                <ul class="accordion-menu">
					...
					<!-----<li>
                    <a href="wallet-history"><i class="material-icons-outlined">wallet</i>Wallet</a>
                    </li>---->
					...
					<li>
						...
						<li><a href="add_internal?to_usertype=territory_partner">Transfer to Territory Partner</a></li>
					...
					<!----<li class="active-page">
                        <a href="manage-coupon.php"><i class="material-icons-two-tone">done</i>
						Coupons</a>
                    </li>---->
					...
					<li>
						...
						<li><a href="add-tp-invoice">Add Invoice</a></li>
                            ...
                            <li><a href="manage-tp-advance-submissions">TP Advance Submissions</a></li>
                        </ul>
                    </li>
					...
					<li>
					 ...
					 <li>
                        <a href="#"><i class="material-icons-two-tone">sentiment_satisfied_alt</i>Distributor<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
						<!----<li><a href="Distributor-add.php?usertype=OpenArea">Add Open Area</a></li>---->
					...
					<li>
                        <a href="stockist-network.php"><i class="material-icons-two-tone">done</i>Users Network</a>
                    </li>
