...
// Ensure target_amount column exists
...
$stmt = $db_conn->prepare("
    ...
    ORDER BY tp.name
");
$stmt->bind_param("s", $Login_user_IDvl);
$stmt->execute();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (!empty($tp['company_name'])): ?>
                                                    <br><small style="color:#9ca3af;font-size:11.5px;"><?php echo htmlspecialchars($tp['company_name']); ?></small>
                                                <?php endif; ?>
                                            </td>
