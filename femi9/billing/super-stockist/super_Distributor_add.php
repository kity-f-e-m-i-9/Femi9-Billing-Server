...
<form action="super_Distributor_action" method="post" enctype="multipart/form-data" id="uploadForm">
...
return $Hash; } $randum_number=GeraHash(12);
date_default_timezone_set("Asia/Kolkata");
$temp_date=date("dmy");
$temp_time=date("gis"); 
$tempID="".$randum_number."SPDT".$temp_date."".$temp_time."";
//SPDT- Super Distributor
?>

<input type="hidden" name="temp_id" value="<?=$tempID?>">
<input type="hidden" name="Coupon_category" value="<?=$Coupon_category?>">
<input type="hidden" name="password" value="12345678">
<input type="hidden" name="usertype" value="super_distributor">
