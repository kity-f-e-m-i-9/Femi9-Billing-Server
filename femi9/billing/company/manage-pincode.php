                        ...
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! one <?php echo $message_title;?> deleted success.</div><?php }?>
									...
									<td><a href="export_pincode" title="Export"><img src="../../assets/images/excel-3-32.png"></a></td>
									</tr>
									</table>
									</h1>
                                </div>
                            ...
                            <div class="col">
                                        ...
                                        <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
                                            <thead>
											 ...
											 <tbody>
										<?php $select_picnode_list="select * from pincode order by id desc";
							   ...
							   $state_name=$result_stateList['st_name'];
										...
										$talulk_name=$result_taluk['taluk'];
											...
											$row_id=base64_encode($result_pincode_list["id"]);
											?>
                                                <tr>
                                                    <td><?php echo ++$i; ?></td>
													<td><?php echo $state_name;?></td>
                                                    <td><?php echo $district_name;?></td>
													<td><?php echo $talulk_name;?></td>
													<td><?php echo $result_pincode_list['id'];?></td>
													<td><?php echo $result_pincode_list['pincode'];?></td>
																										<td>
													    <div class="actions-group">
													        <a href="edit-pincode?prid=<?php echo $row_id;?>" class="action-link" title="Edit"><i class="material-icons-outlined" style="font-size:17px;color:#667eea;">edit</i></a>
													        <a href="delete-pincode?prid=<?php echo $row_id;?>" class="action-link delete" title="Delete" onclick="return confirm('You want to delete confirm?');"><i class="material-icons-outlined" style="font-size:17px;color:#ef4444;">delete_outline</i></a>
													    </div>
													</td>
                                                </tr>
										<?php }?>
