 <!--------------------------------------------------------->
						...
						<div class="row">
                            <div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
										...
										<a href="overview_cash?frdate=<?=$start_date;?>&&todate=<?=$endDate;?>&&today=<?=$today_date;?>&&lable=1&&rptlable=1&&out1=<?=$Total_SSCASH_VLSS_Show_TODAY;?>&&out2=<?=$Total_SSCASH_VLSS_Show_YSTRDY;?>&&out3=<?=$Total_SSCASH_VLSS_Show_THISMONTH;?>&&out4=<?=$Total_SSCASH_VLSS_Show_TLLDTE?>" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Super Stockist</span>
												<table id="reportdash">
												<tr>
												<th>Today</th>
												<td>:&nbsp;<?=$Total_SSCASH_VLSS_Show_TODAY;?></td>
												</tr>
												<!-----<tr>
												<th>Yesterday</th>
												<td>:&nbsp;<?=$Total_SSCASH_VLSS_Show_YSTRDY;?></td>
												</tr>
												<tr>
												<th>This&nbsp;Month</th>
												<td>:&nbsp;<?=$Total_SSCASH_VLSS_Show_THISMONTH;?></td>
												</tr>
												<tr>
												<th>Last&nbsp;Month Till&nbsp;Date</th>
												<td>:&nbsp;<?=$Total_SSCASH_VLSS_Show_TLLDTE;?></td>
												</tr>---->
												</table>
                                            </div>
											</a>
							...
							<div class="col-xl-3"><!--Super Distributors-->
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="overview_cash?frdate=<?=$start_date;?>&&todate=<?=$endDate;?>&&today=<?=$today_date;?>&&lable=4&&rptlable=1&&out1=<?=$Total_SDTCASH_VLSS_Show_TODAY;?>&&out2=0&&out3=0&&out4=0" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">S_Distributors</span>
												<table id="reportdash">
												<tr>
												<th>Today</th>
												<td>:&nbsp;<?=$Total_SDTCASH_VLSS_Show_TODAY;?></td>
												</tr>
												</table>
                                            </div>
											</a>
