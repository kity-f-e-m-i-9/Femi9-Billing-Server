...
<head>
    ...
    <!-- Title -->
    <title>Overview Super Distributor : <?php echo $business_name;?></title>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
									...
									<tr>
									<td>Overview Super Distributor</td>
									</tr>
									</table>
									</h1>
                                </div>
                            ...
                            <div class="col">
                              ...
                              <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
				<?php $select_product_list="select * from super_distributor order by id desc";
...
if($result_product_list['onboard_userTYPE']=="company")
{
	...
	if($result_product_list['onboard_userTYPE']=="super_stockiest"){ $tblname="super_stockiest";}
	if($result_product_list['onboard_userTYPE']=="stockiest"){ $tblname="stockiest";}
	
$select_ssDetails="select * from ".$tblname." where temp_id='".$result_product_list['onboard_userID']."'";
...
$fetch_ssDetails=mysqli_fetch_array($exe_ssDetails);
	...
	$account_mnname=ucwords($fetch_ssDetails['name']);
					...
					<a href="../super_distributor/<?=$result_product_list["user_icon"];?>" target="_blank">
					<img src="../super_distributor/<?=$result_product_list["user_icon"];?>" style="width:90px;border-radius:10px;">
					</a>
					<?php }else{ ?>
