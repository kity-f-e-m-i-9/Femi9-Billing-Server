...
$select_records = "select * from outlet where onboard_userTYPE='$onboard_userTYPE' and onboard_userID='$onboard_userID' order by id asc";
...
// Header row for CSV
$csv_content .= "ID, Name, State, District, Taluk, Pincode, Mobile Number, Email, Address, GSTIN \n";
