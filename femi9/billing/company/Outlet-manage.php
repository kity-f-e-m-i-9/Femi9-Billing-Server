...
<head>
    ...
    <!-- Title -->
    <title>Manage Outlet : <?php echo $business_name;?></title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['addedsuccess'])){?><div class="alert alert-success">Outlet added success.</div><?php }?>
								
								<?php if(isset($_REQUEST['updatedSuccess'])){?><div class="alert alert-info">Changes saved success.</div><?php }?>
								
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! One Outlet Details Deleted Success.</div><?php }?>
								
                                    <h1>
									<table class="headertble">
									<tr>
									<td>Manage Outlet</td>
									<td><a href="Outlet-add" title="Add Distributor">&#10011;</a></td>
									<td><a href="export_outlet" title="Export"><img src="../../assets/images/excel-3-32.png"></a></td>
									</tr>
									</table>
									</h1>
                                </div>
...
<table id="datatable1">
											...
											<tbody>
<?php $select_product_list="select * from outlet where onboard_userTYPE='$onboard_userTYPE' and onboard_userID='$onboard_userID' order by id desc";
...
$pincodeshow=$result_pincodelist['pincode'];
					...
					D:&nbsp;<?=ucwords($district_name);?><br/>T:&nbsp;<?=ucwords($taluk_name);?>
					<br/>P:&nbsp;<?=$pincodeshow;?>
					</td>
					...
					<?php /*?>
					<!----<td>
					<a href="JavaScript:newPopup('update-username.php?pageNme=distributor&&prid=<?php echo $rowid;?>&&ActionUpdate');" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Username">
...
<td>
			<a href="JavaScript:newPopup('Outlet-details?prid=<?php echo $rowid;?>&&actiondetails');" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
	...
	popupWindow = window.open(
		url,'popUpWindow','height=450,width=750,left=350,top=200,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes')
			    ...
			    <div class="actions-group">
			        <a href="Outlet-edit?prid=<?php echo $rowid;?>&&actionupdate" class="action-link" title="Edit"><i class="material-icons-outlined" style="font-size:17px;color:#667eea;">edit</i></a>
			        <a href="Outlet-delete?prid=<?php echo $rowid;?>&&couponcat=<?php echo $Coupon_category;?>&&actionremove" class="action-link delete" title="Delete" onclick="return confirm('You want to delete confirm?');"><i class="material-icons-outlined" style="font-size:17px;color:#ef4444;">delete_outline</i></a>
			    </div>
			</td>
                                                </tr>
