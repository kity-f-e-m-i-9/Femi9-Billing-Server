...
if($onboardby=='stockiest')
{
	$Tablename="stockiest";
	$LableName="Stockist";
}
if($onboardby=='super_distributor')
{
	$Tablename="super_distributor";
	$LableName="Super Distributor";
}
if($onboardby=='distributor')
{
	$Tablename="distributor";
	$LableName="Distributor";
}
?>
<!-------C & F || Super Stockist || Stockist || Super Distributor || Distributor--------------->
