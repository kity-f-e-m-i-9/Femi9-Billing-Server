...
<input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                        <div class="example-container">
                                            <div class="example-content">
                                                ...
                                                <input type="text" required="" name="st_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onkeypress="restrictSpecialChars(event)">
												
												<br/>
												
												<button type="submit" name="add-state" class="btn btn-primary"><i class="material-icons">add</i>Add</button>
