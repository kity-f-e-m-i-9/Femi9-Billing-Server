...
<head>
    ...
    <!-- Title -->
    <title>Overview Stockist : <?php echo $business_name;?></title>
...
$select_ssDetails="select * from super_stockiest where temp_id='".$result_product_list['onboard_userID']."'";
...
$fetch_ssDetails=mysqli_fetch_array($exe_ssDetails);
	...
	$account_mnname=ucwords($fetch_ssDetails['name']);
					...
					<a href="../super-stockist/<?=$result_product_list["user_icon"];?>" target="_blank">
					<img src="../super-stockist/<?=$result_product_list["user_icon"];?>" style="width:90px;border-radius:10px;">
					</a>
					<?php }else{ ?>
