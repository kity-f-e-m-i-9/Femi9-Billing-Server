        ...
        <div class="app-content">
            <div class="content-wrapper">
                <div class="container-fluid">
                        ...
                        <div class="col-md-4">
                            <div class="card h-100">
                                <div class="card-body inv-block">
                                    ...
                                    <div style="font-size:16px;font-weight:700;"><?php echo htmlspecialchars($inv['source_location']); ?></div>
                                    <div style="font-size:12px;color:#888;">Partner Location</div>
                                    <?php if ($inv['cp_name']): ?>
                                    <hr style="margin:10px 0;">
                                    <table class="inv-meta">
                                        <tr><td>Managed by</td><td><?php echo htmlspecialchars($inv['cp_name']); ?></td></tr>
                                        <tr><td>CP ID</td><td><code><?php echo htmlspecialchars($inv['cp_code']); ?></code></td></tr>
                                    </table>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <a href="manage-tp-invoices" class="btn btn-secondary">
