...
<td>
    ...
    // button.
    function shareShopUserInvoiceDirect(btn) {
        ...
        iframe.src = 'shop-user-invoice-print?invoiceid=' + encodeURIComponent(id);
