                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['mappingsuccess'])){?><div class="alert alert-success">Super Distributors Re-mapping Success.</div><?php }?>
								
								
                                     <h2>
									<table class="headertble">
									<tr>
									<td>Re-mapping : <i><span style="color:green;">Super Distributors</span></i> </td>
									</tr>
									</table>
									</h2>
                                </div>
...
<form action="remapping_superdistributor2" method="post" enctype="multipart/form-data">
...
xmlhttp.open("GET","load612.php?q="+str,true);
xmlhttp.send();}
</script>
