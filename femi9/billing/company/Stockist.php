...
<head>
    ...
    <!-- Title -->
    <title>Stockist : <?php echo $business_name;?></title>
                        ...
                        <div class="row">
                            <div class="col">
                              ...
                              <table id="datatable3">
											...
											<tbody>
				<?php $select_product_list="select * from stockiest order by id desc";
...
$taluk_name=$result_district['taluk'];
					...
					<td>
					<a href="JavaScript:newPopup('update-username.php?pageNme=stockist&&prid=<?php echo $rowid;?>&&ActionUpdate');" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Username">
			        <b><?php echo $result_product_list["username"];?></b></a>
					</td>
					
					<td>&#8377; <?php echo $result_product_list["plan_amount"];?><br/>
					<?php echo $result_product_list["valid_months"];?> Months<br/>
...
<td>
			<a href="JavaScript:newPopup('details-stockist.php?prid=<?php echo $rowid;?>&&actiondetails');" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
