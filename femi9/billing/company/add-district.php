...
<input type="hidden" name="temp_id" value="<?=$tempID?>">
						   ...
						   <option value="<?php echo $result_stateList['id'];?>"><?php echo $result_stateList['st_name'];?></option>
							   <?php }?>
                                                ...
                                                <input type="text" required="" name="dist_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onkeypress="restrictSpecialChars(event)">
												
												<br/>
												
												<button type="submit" name="add-district" class="btn btn-primary"><i class="material-icons">add</i>Add</button>
