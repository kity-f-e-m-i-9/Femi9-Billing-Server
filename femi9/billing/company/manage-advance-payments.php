...
<head>
    ...
    <title>Manage Payment Entry | <?php echo htmlspecialchars($business_name, ENT_QUOTES, 'UTF-8'); ?></title>
                                        ...
                                        <div class="row g-3 align-items-end">
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex gap-2 justify-content-end">
                                                    ...
                                                    <a href="manage-advance-payments.php" class="btn btn-reset">
        ...
        const table = $('#advancePaymentsTable').DataTable({
            ...
            ajax: {
                ...
                dataSrc: function(json) {
                    ...
                    // Update statistics
                    if (json.stats) {
                        $('#stat_total_payments').text(json.stats.total_payments || 0);
            ...
            columns: [
                ...
                { data: 'to_user_name', render: escapeHtml },
                { data: 'to_user_type', render: d => escapeHtml(formatUserType(d)) },
                { 
                ...
                { data: 'payment_mode', render: d => escapeHtml(d || 'N/A') },
                { data: 'reference_number', render: d => escapeHtml(d || '-') },
                { 
                    data: 'status',
                    render: function(d) {
