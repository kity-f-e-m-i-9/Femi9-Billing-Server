...
{
	$displaytitle="Update Delivery Note : Outlet Invoice";
                                ...
                                <div class="card">
									...
									<div id="overflowon">
                                        <table id="datatable1" class="display" style="width:100%;">
											...
											<tbody>
										<?php $select_product_list="select * from user_invoice where from_user_type='$Login_user_TYPEvl' and to_user_type='$getinvuser' order by id desc";
...
error_reporting(0);$select_Customers="select * from ".$tablename." where temp_id='$CuSTID'";
