...
<head>
    ...
    <!-- Title -->
    <title>Purchase Order Product Details</title>
...
<body>
                        ...
                        <div style="padding:20px;">
						 <h1>Purchase Order Product Details
									</h1>
									<hr/>
</div>
...
<?php
$select_picnode_list="select * from stock_request_items where reqid='$reqid' order by id asc";
