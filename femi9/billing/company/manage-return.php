...
<head>
    ...
    <!-- Title -->
    <title>Manage Return Stocks : <?php echo $business_name;?></title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['addesuccess'])){?><div class="alert alert-success">Return stock details added success.</div><?php }?>
								
								<?php if(isset($_REQUEST['updatedSuccess'])){?><div class="alert alert-info">Changes saved success.</div><?php }?>
								
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! one Return stock details deleted success.</div><?php }?>
								
                                    <h1>
									<table class="headertble">
									<tr>
									<td>Manage Return Stocks</td>
									<td><a href="add-return" title="Add Customer">&#10011;</a></td>
									</tr>
									</table>
									</h1>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
			<?php $select_product_list="select * from company_return_stock order by date desc";
			...
			while($result_product_list=mysqli_fetch_array($fetch_product_list))
										{
											...
											//
											$product_id=$result_product_list['prid'];
