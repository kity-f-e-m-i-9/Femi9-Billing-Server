...
<head>
    ...
    <title>Channel Partner to Company Profile Return : <?php echo $business_name; ?></title>
    ...
    <style>
        ...
        .card-header-title i { font-size: 18px; color: #f59e0b; }
        ...
        .btn-return:hover { transform: translateY(-2px); box-shadow: 0 6px 16px rgba(245,158,11,.4); color: #fff; }
        .btn-return:disabled { opacity: .5; transform: none; box-shadow: none; cursor: not-allowed; }
        .btn-cancel {
            padding: 10px 20px;
            border-radius: 7px;
            font-size: 14px;
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-description">
                                <h1>
                                    <table class="headertble"><tr>
                                        <td>Channel Partner → Company Profile</td>
                    ...
                    <div class="row mb-2"><div class="col">
                        <div class="alert alert-danger">
                            ...
                            <?php $e=$_GET['error'];
                            echo $e==='insufficient'      ? 'Insufficient stock at the partner location for one or more products.'
                    ...
                    <form action="pl-godown-transfer-action" method="post" id="transferForm">
                        ...
                        <input type="hidden" name="transfer_type" value="location_to_godown">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <span class="transfer-badge">
                                    ...
                                    Channel Partner → Company Profile
                                </span>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Source Channel Partner <span class="req">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Destination Company Profile <span class="req">*</span></label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-warning btn-add-row" id="addRowBtn" style="display:none;">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div id="productPlaceholder" class="empty-state">
                                    ...
                                    <p>Select a source channel partner to load available stock</p>
                                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                <button type="submit" class="btn btn-return" id="submitBtn" disabled>
...
(function ($) {
    ...
    $('#locationSelect').on('change', function () {
        ...
        if (!lid) {
            $('#productSection').hide();
            $('#addRowBtn').hide();
            $('#productPlaceholder').show().html('<i class="material-icons-outlined" style="font-size:52px;display:block;margin-bottom:12px;opacity:.5;">inventory</i><p style="font-size:13.5px;color:#9ca3af;margin:0;">Select a source channel partner to load available stock</p>');
        ...
        $.getJSON('get-location-stock-products.php?cp_id=' + lid, function (data) {
            products = data;
            if (!products.length) {
                $('#productPlaceholder').show().html('<i class="material-icons-outlined" style="font-size:52px;display:block;margin-bottom:12px;color:#f59e0b;opacity:.7;">warning_amber</i><p style="font-size:13.5px;color:#9ca3af;margin:0;">No stock available at this location</p>');
                $('#productSection').hide();
                $('#addRowBtn').hide();
                $('#submitBtn').prop('disabled', true);
                return;
