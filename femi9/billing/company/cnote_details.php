...
include("config.php");
	...
	$user=$result_invoicedtails['from_usertype'];
	
	//Get Invoice Number
	if($user=="customer")
	{
	$select_invoicedetails12="select * from invoice where inv_id='$invid'";
	}else{
...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
		...
		<a href="cnote_manage" id="linkbackvl">&#8630;&nbsp;Go Back</a>
					...
					<div style="font-size:12px;margin-top:5px;"><?=$user;?></div>
									</td>
									<td>&nbsp;</td>
									</tr>
									</table>
...
<!----------------------------------------------------------------------------->		
	...
	//product dteails
		...
		$InvoiceID=base64_encode($result_INVProductDetails['invnumber']);
	?>
                                                        <tr>
