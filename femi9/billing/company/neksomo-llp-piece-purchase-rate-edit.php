...
$stmt = $db_conn->prepare("SELECT * FROM neksomo_llp_piece_purchase_rates WHERE id = ?");
...
if (!$entry) {
    header("Location: neksomo-llp-piece-purchase-rate-manage.php");
    exit;
}
...
<head>
    ...
    <title>Edit Purchase Rate : <?php echo $business_name; ?></title>
                            ...
                            <div class="col">
                                <div class="page-description">
                                    <h1>
                                        ...
                                        <tr>
                                        <td>Edit Purchase Rate</td>
                                        <td><a href="neksomo-llp-piece-purchase-rate-manage.php" title="Manage Rates">&#9776;</a></td>
                                        </tr>
                                        </table>
                                    </h1>
                                </div>
...
<form action="neksomo-llp-piece-purchase-rate-action.php" method="post">
