...
//---------------------------------------------------------------------------------
//Today Invoice Count
$select_count_invoice_today_shop="select count(*) as numinvoicetdy from user_invoice where date='$today_date' and to_user_type='shop' and sub_total>0";
...
//Today Product Qty
$select_prqty_today_shop="select sum(qty) from user_invoice_items where date='$today_date' and to_user_type='shop'";
...
//Today Total Amount
$select_totalamount_today_shop="select sum(total) from user_invoice where date='$today_date' and to_user_type='shop'";
...
$select_count_invoice_yesterday_shop="select count(*) as numinvoicetdy from user_invoice where date='$Yesterday_date' and to_user_type='shop' and sub_total>0";
...
$select_prqty_yesterday_shop="select sum(qty) from user_invoice_items where date='$Yesterday_date' and to_user_type='shop'";
...
$select_totalamount_yesterday_shop="select sum(total) from user_invoice where date='$Yesterday_date' and to_user_type='shop'";
...
$select_count_invoice_thismonth_shop="select count(*) as numinvoicetdy from user_invoice where date between '$start_date' and '$endDate' and to_user_type='shop' and sub_total>0";
...
$select_prqty_thismonth_shop="select sum(qty) from user_invoice_items where date between '$start_date' and '$endDate' and to_user_type='shop'";
...
$select_totalamount_thismonth_shop="select sum(total) from user_invoice where date between '$start_date' and '$endDate' and to_user_type='shop'";
...
$select_count_invoice_lastmonth_shop="select count(*) as numinvoicetdy from user_invoice where date between '$lastmonth_date_start' and '$lastmonth_date_end' and to_user_type='shop' and sub_total>0";
...
$select_prqty_lastmonth_shop="select sum(qty) from user_invoice_items where date between '$lastmonth_date_start' and '$lastmonth_date_end' and to_user_type='shop'";
...
$select_totalamount_lastmonth_shop="select sum(total) from user_invoice where date between '$lastmonth_date_start' and '$lastmonth_date_end' and to_user_type='shop'";
