...
$_tp_cols = [
    ...
    'referral_type'       => "VARCHAR(20) DEFAULT NULL AFTER referral_id",
    'referral_percentage' => "DECIMAL(5,2) DEFAULT NULL AFTER referral_type",
...
if ($action === 'update-territory-partner') {
    ...
    try {
        ...
        // Delete old photo file after successful DB update
