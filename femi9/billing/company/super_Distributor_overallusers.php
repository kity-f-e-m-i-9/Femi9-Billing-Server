...
$displaytitle="Overall - Super Distributors";
$tablename="super_distributor";
$xlurl="super_Distributor_ex_overallusers";
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div style="overflow-x:auto;">
                                            <table id="datatable1" class="table" style="width:100%;">
                                                ...
                                                while($result_product_list=mysqli_fetch_array($fetch_product_list))
                                                {
                                                    ...
                                                    elseif($result_referralDetails['ref_by_user_type']=="super_stockiest"){
                                                        $tblename="super_stockiest";
                                                        $labelname="Super&nbsp;Stockist";
                                                    }
                                                    elseif($result_referralDetails['ref_by_user_type']=="stockiest"){
                                                        $tblename="stockiest";
                                                        $labelname="Stockist";
                                                    }
                                                    else{
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        {
                                                        ?>
                                                            <a href="inactive_user?usr=super_distributor&&backurl=super_Distributor_overallusers&&usrid=<?=$rowid;?>&&usrname=<?=base64_encode($result_product_list["name"]);?>&&userlabel=Super-Distributor" onclick="return confirm('You want to confirm Deactivate this (<?php echo strtoupper($result_product_list["name"]);?>)  user?');"><span class='badge badge-style-bordered badge-success'>Active</span></a>
                                                        <?php
                                                        }else{
                                                        ?>
                                                            <a href="active_user?usr=super_distributor&&backurl=super_Distributor_overallusers&&usrid=<?=$rowid;?>&&usrname=<?=base64_encode($result_product_list["name"]);?>&&userlabel=Super-Distributor" onclick="return confirm('You want to confirm Activate this (<?php echo strtoupper($result_product_list["name"]);?>)  user?');"><span class='badge badge-style-bordered badge-danger'>Deactive</span></a>
                                                        <?php
                                                        }
                                                        ?>
                                                    </td>
                                                    ...
                                                    <!-------------------Update referral---------------------------------->
                                                    <?php if($result_referralDetails['ref_by_user_type']=="company"){?>
                                                        <td class="text-center">---</td>
                                                        <td>
                                                            <div style="display:flex; align-items:center; gap:8px;">
                                                                <span>Company</span>
                                                                <a href="JavaScript:newPopup('super_Distributor_update_referral.php?sdid=<?=$result_product_list['temp_id'];?>');">
                                                        ...
                                                        <td class="text-center">---</td>
                                                    <?php }else{?>
                                                        <td class="text-center"><?=$result_referralDetails['ref_by_user_id'];?></td>
                                                        <td>
                                                    ...
                                                    <!-- Edit Column -->
                                                    <td class="text-center">
                                                        <a href="super_distributor-edit?prid=<?php echo $rowid; ?>" 
                                                           class="edit-btn" 
                                                           title="Edit Super Distributor">
