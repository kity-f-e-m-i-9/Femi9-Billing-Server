...
<head>
    ...
    <!-- Title -->
    <title>Distributor : <?php echo $business_name;?></title>
...
<td>
			<a href="JavaScript:newPopup('details-dis.php?prid=<?php echo $rowid;?>&&actiondetails');" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
