...
{
	echo "<script>window.location='remapping_distributor';</script>";
	exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <!-- Title -->
    <title>Re-mapping : Distributors : <?php echo $business_name;?></title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<a href="remapping_distributor" id="linkbackvl">&#8630;&nbsp;Go Back</a>
                                     <h2>
									<table class="headertble margintop10">
									<tr>
									<td>
									Re-mapping : <i><span style="color:green;">Distributors</span></i>
									</td>
									</tr>
									</table>
									</h2>
...
<?php 
$select_supersotkistCOUNT="select count(*) as numMAPP from distributor where onboard_userTYPE='$get_from_user_type' and onboard_userID='$get_from_user_id'";
...
<form action="remapping-action" method="post" enctype="multipart/form-data" onSubmit="return confirm('Please make a confirm!');">
                                        ...
                                        <div class="example-container">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">
                                                    <strong>Select Distributors to Remap:</strong> 
					...
					<?php 
					$select_supersotkist="select * from distributor where onboard_userTYPE='$get_from_user_type' and onboard_userID='$get_from_user_id' order by id asc";
        ...
        <input class="form-check-input me-1 distributor-checkbox" name="distributorid[]" type="checkbox" value="<?=$result_supersotkist['id'];?>" aria-label="Select distributor">
...
xmlhttp.open("GET","load891.php?q="+str,true);
xmlhttp.send();}
</script>
...
<button type="submit" name="REMAPPING2" class="btn btn-primary">
...
<?php }?>
    ...
    function selectAllDistributors() {
        var checkboxes = document.querySelectorAll('.distributor-checkbox');
