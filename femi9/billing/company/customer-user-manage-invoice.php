...
<head>
    ...
    <!-- Title -->
    <title><?=$displaytitle;?>  : <?=$business_name;?></title>
...
<button type="submit" name="sedatas" class="btn btn-primary"><i class="material-icons">search</i>Search</button>
							...
							<br/>
									...
									<tr>
									<td><?=$displaytitle;?></td>
									<td><a href="customer-user-invoice-add" title="Add Invoice">&#10011;</a></td>
									</tr>
									</table>
									</h1>
                                </div>
...
?>
                                ...
                                <div class="card">
									...
									<div id="overflowon">
                                        <table id="datatable1" class="display" style="width:100%;">
											...
											<tbody>
										<?php $select_product_list="select * from invoice where user_type='$Login_user_TYPEvl' and date between '$from_date' and '$to_date' order by id desc";
										...
										$Cust_Mbile=$result_Customers['mobile'];
											...
											?>
                                                ...
                                                <tr>
													...
													<td>
													<?php if($CuSTID!=0){?>
													<?php echo $Cust_Name;?><br/>M:&nbsp;<?php echo $Cust_Mbile;?>
													<?php }else{ echo "Walking&nbsp;Customer";}?>
			...
			?>
													...
													<a href="update_customer3.php?invuser=<?=$getinvuser;?>&&InvoiceID=<?=$result_product_list["inv_id"];?>" style="text-decoration:none;"><span class='badge badge-style-bordered badge-primary'>Update</span>
													</a>
...
<a href="customer-user-invoice-print?invoiceid=<?php echo base64_encode($result_product_list["inv_id"]);?>&whatsapp_share=1" title="Share to WhatsApp"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="#25D366"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2 22l5.29-1.39c1.44.79 3.06 1.2 4.71 1.2h.01c5.46 0 9.9-4.45 9.9-9.9C21.91 6.45 17.5 2 12.04 2zm5.8 14.03c-.24.68-1.4 1.32-1.93 1.4-.5.08-1.13.11-1.82-.11-.42-.13-.96-.31-1.65-.61-2.9-1.25-4.79-4.17-4.94-4.36-.14-.19-1.18-1.57-1.18-3 0-1.42.75-2.12 1.02-2.41.27-.29.58-.36.78-.36.19 0 .39 0 .56.01.18.01.42-.07.66.5.24.58.83 2 .9 2.15.07.15.12.32.02.51-.1.19-.15.31-.29.48-.15.17-.31.38-.44.51-.15.15-.3.31-.13.6.17.29.76 1.25 1.63 2.02 1.12 1 2.06 1.31 2.35 1.46.29.15.46.13.63-.08.17-.21.72-.84.92-1.13.19-.29.38-.24.64-.14.26.1 1.65.78 1.94.92.29.15.48.22.55.34.07.13.07.72-.17 1.4z"/></svg></a>
</div>
<?php }else{?>
...
<?php }?>
													    ...
													    <div class="actions-group">
													        <a href="customer-user-invoice-add?invuser=<?=$getinvuser;?>&&InvoiceID=<?=$INVID_encode;?>&&gid=<?=$result_product_list['user_id'];?>&&action=edit" class="action-link" title="Edit"><i class="material-icons-outlined" style="font-size:17px;color:#667eea;">edit</i></a>
													    </div>
													</td>
...
<td>
    <div class="actions-group">
        <a href="delinvoice?invtype=customer&&invuser=<?=$getinvuser;?>&&invid=<?=$INVID_encode;?>" class="action-link delete" title="Delete" onclick="return confirm('You want to delete confirm?');"><i class="material-icons-outlined" style="font-size:17px;color:#ef4444;">delete_outline</i></a>
    </div>
</td>
