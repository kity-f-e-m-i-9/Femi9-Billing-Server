...
<td>
    ...
    <script>
    // Shares a customer invoice straight to WhatsApp from this list — no
    ...
    // own button.
    function shareCustomerUserInvoiceDirect(btn) {
        ...
        iframe.src = 'customer-user-invoice-print?invoiceid=' + encodeURIComponent(id);
