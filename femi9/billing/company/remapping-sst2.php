...
{
	echo "<script>window.location='remapping-sst';</script>";
	exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <!-- Title -->
    <title>Re-mapping : Stockist : <?php echo $business_name;?></title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<a href="remapping-sst" id="linkbackvl">&#8630;&nbsp;Go Back</a>
                                     <h2>
									<table class="headertble margintop10">
									<tr>
									<td>
									Re-mapping : <i><span style="color:green;">Stockist</span></i>
									</td>
									</tr>
									</table>
									</h2>
									...
									<?php 
if($get_from_user_type=='candf' || $get_from_user_type=='super_stockiest')
{
...
<?php 
$select_supersotkistCOUNT="select count(*) as numMAPP from stockiest where onboard_userTYPE='$get_from_user_type' and onboard_userID='$get_from_user_id'";
...
<form action="remapping-action" method="post" enctype="multipart/form-data" onSubmit="return confirm('Please make a confirm!');">
                                        ...
                                        <div class="example-container">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">
                                                    <strong>Select Stockists to Remap:</strong> 
                                                    (<?php echo $result_supersotkistCNT['numMAPP']; ?> stockists found)
                                                </label>
                                                <div class="mb-2">
                                                    <button type="button" class="btn btn-sm btn-secondary" onclick="selectAllStockists()">
                                                        <i class="material-icons" style="font-size: 16px; vertical-align: middle;">check_box</i> Select All
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-secondary" onclick="deselectAllStockists()">
					...
					<?php 
					$select_supersotkist="select * from stockiest where onboard_userTYPE='$get_from_user_type' and onboard_userID='$get_from_user_id' order by id asc";
        ...
        <input class="form-check-input me-1 stockist-checkbox" name="stockistid[]" type="checkbox" value="<?=$result_supersotkist['id'];?>" aria-label="Select stockist">
...
xmlhttp.open("GET","load_remapping_users2.php?q="+str,true);
xmlhttp.send();}
</script>
...
<option value="" hidden="">Select User (Assigned to)</option>
												...
												<button type="submit" name="REMAPPING_SUPERSTOCKIST" class="btn btn-primary"><i class="material-icons"></i>Submit</button>
...
<?php }?>
    ...
    <script>
    /**
     * Select all stockists
     */
    function selectAllStockists() {
        var checkboxes = document.querySelectorAll('.stockist-checkbox');
    ...
    /**
     * Deselect all stockists
     */
    function deselectAllStockists() {
        var checkboxes = document.querySelectorAll('.stockist-checkbox');
        checkboxes.forEach(function(checkbox) {
