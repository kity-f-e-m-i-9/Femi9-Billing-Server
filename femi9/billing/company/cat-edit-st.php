...
$title="Update Category (Stockist)";
...
$select_product_list="select * from stockist_category where id='$prid'";
...
<input type="hidden" name="update_id" value="<?php echo $result_product_list["id"]?>">
                                        ...
                                        <div class="example-container">
                                            <div class="example-content">
                                                ...
                                                <input type="text" required="" name="catname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onkeypress="restrictCountryName(event)" value="<?=$result_product_list['catname'];?>">
												<br/>
												...
												<button type="submit" name="UpdateStockistCategory" class="btn btn-primary">Update</button>
