...
function getXMLHTTP() { //fuction to return the xml http object
    ...
    <select name="state_id" class="form-control" onChange="getDistrict(this.value)" required="">
	<option value="" hidden="">Select</option>
...
<?php }?>
            ...
            <div class="mobile-number">
                ...
                <input type="text" required name="mobile_number" onkeypress="restrictnumber(event)" class="form-control" maxlength="10">
            </div>
        </div>
        <!-- New add end -->
        <!-- #hided 
			<label class="form-label">Mobile Number</label>
            <input type="text" onkeypress="restrictnumber(event)" pattern="[1-9]{1}[0-9]{9}" required="" name="mobile_number" class="form-control" maxlength="10">-->
			<br/>
...
<label class="form-label">Landline Number</label>
            ...
            <input type="text" maxlength="15" onkeypress="restrictGSTIN(event)" name="gstin" class="form-control">
