                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            <div class="row invoice-summary">
                                                ...
                                                <!-- ADD RETURN FORM -->
                                                <form action="cnote_action.php" method="post" enctype="multipart/form-data" onSubmit="return confirm('Are you sure you want to add this return item?');">
                                                    ...
                                                    <button type="submit" name="add-return" class="btn btn-primary" style="width:100%;">
