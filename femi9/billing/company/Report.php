           ...
           <?php include("app-header.php");?>
            ...
            <div class="app-content">
				...
				<?php include("report_onboarded.php"); ?>
						...
						<div class="row">
                            <div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="overview-report4?frdate=<?=$start_date;?>&&todate=<?=$endDate;?>&&today=<?=$today_date;?>&&lable=1&&rptlable=1&&out1=<?=$countss_today;?>&&out2=<?=$countss_month;?>&&out3=<?=$countss_Overall;?>" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
							...
							<div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="overview-report4?frdate=<?=$start_date;?>&&todate=<?=$endDate;?>&&today=<?=$today_date;?>&&lable=2&&rptlable=1&&out1=<?=$count_stock_today;?>&&out2=<?=$count_stock_month;?>&&out3=<?=$countst_Overall;?>" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Stockist</span>
												<table id="reportdash">
												<tr>
												<th>Today</th>
												<td>:&nbsp;<?=$count_stock_today;?></td>
												</tr>
												<tr>
												<th>This&nbsp;Month</th>
												<td>:&nbsp;<?=$count_stock_month;?></td>
												</tr>
												<tr>
												<th>Total</th>
												<td>:&nbsp;<?=$countst_Overall;?></td>
												</tr>
												</table>
                                            </div>
											</a>
							...
							<div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="overview-report4?frdate=<?=$start_date;?>&&todate=<?=$endDate;?>&&today=<?=$today_date;?>&&lable=3&&rptlable=1&&out1=<?=$count_distributor_today;?>&&out2=<?=$count_distributor_month;?>&&out3=<?=$countdt_Overall;?>" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Distributors</span>
												<table id="reportdash">
												<tr>
												<th>Today</th>
												<td>:&nbsp;<?=$count_distributor_today;?></td>
												</tr>
												<tr>
												<th>This&nbsp;Month</th>
												<td>:&nbsp;<?=$count_distributor_month;?></td>
												</tr>
												<tr>
												<th>Total</th>
												<td>:&nbsp;<?=$countdt_Overall;?></td>
												</tr>
												</table>
                                            </div>
											</a>
							...
							<div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="overview-report4?frdate=<?=$start_date;?>&&todate=<?=$endDate;?>&&today=<?=$today_date;?>&&lable=5&&rptlable=1&&out1=<?=$count_SD_today;?>&&out2=<?=$count_SD_month;?>&&out3=<?=$count_SD_Overall;?>" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Super Distributors</span>
												<table id="reportdash">
												<tr>
												<th>Today</th>
												<td>:&nbsp;<?=$count_SD_today;?></td>
												</tr>
												<tr>
												<th>This&nbsp;Month</th>
												<td>:&nbsp;<?=$count_SD_month;?></td>
												</tr>
												<tr>
												<th>Total</th>
												<td>:&nbsp;<?=$count_SD_Overall;?></td>
												</tr>
												</table>
                                            </div>
											</a>
							...
							<!------<div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="#" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Outlet</span>
												<table id="reportdash">
												<tr>
												<th>Today</th>
												<td>:&nbsp;<?=$count_outlet_today;?></td>
												</tr>
												<tr>
												<th>This&nbsp;Month</th>
												<td>:&nbsp;<?=$count_outlet_month;?></td>
												</tr>
												<tr>
												<th>Total</th>
												<td>:&nbsp;<?=$countotl_Overall;?></td>
												</tr>
												</table>
                                            </div>
											</a>
						...
						<div class="row">
                            <div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
						<a href="<?=$poorder_link;?>?frdate=<?=$today_date;?>&&todate=<?=$today_date;?>&&lable=1&&rptlable=1&&out1=<?=$today_invoice_count_purchaseorder;?>&&out2=<?=$today_total_qty_purchaseorder;?>&&out3=0" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Today</span>
												<table id="reportdash">
												<tr>
							...
							<div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="<?=$poorder_link;?>?frdate=<?=$Yesterday_date;?>&&todate=<?=$Yesterday_date;?>&&lable=2&&rptlable=1&&out1=<?=$yesterday_invoice_count_purchaseorder;?>&&out2=<?=$yesterday_total_qty_purchaseorder;?>&&out3=0" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Yesterday</span>
												<table id="reportdash">
												<tr>
							...
							<div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
										...
										<a href="<?=$poorder_link;?>?frdate=<?=$start_date;?>&&todate=<?=$endDate;?>&&lable=3&&rptlable=1&&out1=<?=$thismonth_invoice_count_purchaseorder;?>&&out2=<?=$thismonth_total_qty_purchaseorder;?>&&out3=0" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">This Month</span>
												<table id="reportdash">
												<tr>
							...
							<div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
										<a href="<?=$poorder_link;?>?frdate=<?=$lastmonth_date_start;?>&&todate=<?=$lastmonth_date_end;?>&&lable=4&&rptlable=1&&out1=<?=$lastmonth_invoice_count_purchaseorder;?>&&out2=<?=$lastmonth_total_qty_purchaseorder;?>&&out3=0" style="text-decoration:none;" id="dashanch">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Last Month</span>
												<table id="reportdash">
												<tr>
						...
						<!-------------MARKET STOCK REPORT---------------------->
						<!--------------------------------------------------------->
						<?php include("report_market_stock.php");?>
						<h3><b>Market Stock Report</b></h3>
						<div class="row">
                            <div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
						...
						<a href="stock_report?modelval=usr1&&out1=<?=base64_encode($Totalstock_VLSS_Show)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">S_Stockist</span>
                                                <span class="widget-stats-amount"><?=$Totalstock_VLSS_Show?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
						...
						<a href="stock_report?modelval=usr2&&out1=<?=base64_encode($Totalstock_VLSTK_Show)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Stockist</span>
                                                <span class="widget-stats-amount"><?=$Totalstock_VLSTK_Show;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
							 ...
							 <div class="col-xl-3">
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            <div class="widget-stats-icon widget-stats-icon-alert">
                                                <i class="material-icons-outlined">person</i>
                                            </div>
											
						<a href="stock_report?modelval=usr3&&out1=<?=base64_encode($Totalstock_VLDIST_Show)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Distributors</span>
                                                <span class="widget-stats-amount"><?=$Totalstock_VLDIST_Show;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
						...
						<a href="stock_report?modelval=usr4&&out1=<?=base64_encode($Totalstock_VLSD_Show)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">S_Distributors</span>
                                                <span class="widget-stats-amount"><?=$Totalstock_VLSD_Show;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
						...
						<a href="stock_report?modelval=usr4&&out1=0" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Outlets</span>
