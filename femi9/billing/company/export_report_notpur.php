...
// Header row for CSV
$csv_content .= "User ID, Name, District\n";

// Fetching data and formatting into CSV rows

$selectRcd_VLSS1="select * from temp_not_purchased where purchse_count='0' and usertype='super_stockiest'";
...
$selectRcd_VLSS1="select * from temp_not_purchased where purchse_count='0' and usertype='stockiest'";
										$fetchRcd_VLSS1=mysqli_query($db_conn,$selectRcd_VLSS1);
										while($resultRcd_VLSS1=mysqli_fetch_array($fetchRcd_VLSS1))
										{
...
//-----------------------------------------------------------usr3-------------------------------------
if($_REQUEST['modelval']=="usr3" || $_REQUEST['modelval']=="usr4"){	
	
// Header row for CSV
$csv_content .= "User ID, Name, District, Taluk\n";

// Fetching data and formatting into CSV rows
$selectRcd_VLSS1="select * from temp_not_purchased where purchse_count='0' and usertype='$usertype_stock'";
										$fetchRcd_VLSS1=mysqli_query($db_conn,$selectRcd_VLSS1);
										while($resultRcd_VLSS1=mysqli_fetch_array($fetchRcd_VLSS1))
										{
