                            ...
                            <div class="col">
                                <div class="page-description">
                                    ...
                                    <h1>
                                        ...
                                        <tr>
                                        <td>Femi9 LLP Per-Piece Rates</td>
                                        <td><a href="neksomo-llp-piece-sale.php" title="Add Rate">&#10011;</a></td>
                                        </tr>
                                        </table>
                                    </h1>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="actions-group">
                                                            <a href="neksomo-llp-piece-sale-edit.php?id=<?php echo $eid; ?>" class="action-link" title="Edit"><i class="material-icons-outlined" style="font-size:17px;color:#667eea;">edit</i></a>
                                                            <a href="delete-neksomo-llp-piece-sale.php?id=<?php echo $eid; ?>" class="action-link delete" title="Delete" onclick="return confirm('Delete this rate entry?');"><i class="material-icons-outlined" style="font-size:17px;color:#ef4444;">delete_outline</i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
