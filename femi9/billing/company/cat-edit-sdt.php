...
$title="Update Category (Super Distributor)";
...
$select_product_list="select * from super_distributor_category where id='$prid'";
...
<input type="hidden" name="prid" value="<?php echo $prid?>">
                                        ...
                                        <div class="example-container">
                                            <div class="example-content">
												...
												<button type="submit" name="UpdateSuperDistributorCategory" class="btn btn-primary">Update</button>
