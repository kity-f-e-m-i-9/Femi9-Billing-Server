                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['mappingsuccess'])){?><div class="alert alert-success">Distributors Re-mapping Success.</div><?php }?>
								
								
                                     <h2>
									<table class="headertble">
									<tr>
									<td>Re-mapping : <i><span style="color:green;">Distributors</span></i> </td>
									</tr>
									</table>
									</h2>
                                </div>
...
<form action="remapping_distributor2" method="post" enctype="multipart/form-data">
...
xmlhttp.open("GET","load89.php?q="+str,true);
xmlhttp.send();}
</script>
