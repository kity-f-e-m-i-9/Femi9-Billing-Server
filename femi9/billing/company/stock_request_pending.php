                        ...
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
									...
									<tr>
									<td><h1>Stock Request Pending</h1><h3>Purchase Order</h3></td>
									</tr>
									</table>
                                </div>
                            </div>
...
?>
                                ...
                                <div class="card">
									...
									<div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
					<?php $select_product_list="select * from stock_request where touserid='$Login_user_IDvl' and tousertype='$Login_user_TYPEvl' and status='pending' and verified='1' order by id desc";
				...
				//godown id
				$select_invoice_details="select * from user_invoice where inv_id='$reqid'";
	...
	$godownid=$result_invoice_details['from_user_id'];
	...
	//get qty total
				...
				{$trns_AMount=$result_product_list["amount"];}else{$trns_AMount="0";}
				?>
  <tr valign="top">
                                                    <td><?php echo ++$i; ?></td>
...
<!----<td><?=$result_product_list['reqtype'];?></td>---->							
													...
													<td>
			<a href="stock_request_details?reqid=<?=base64_encode($reqid);?>&&gid=<?=$godownid;?>" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
