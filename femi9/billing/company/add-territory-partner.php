            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <form action="territory-partner-action" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="action" value="insert-territory-partner">
                    ...
                    <div class="row mt-1 mb-3">
                        <div class="col">
                            <button type="submit" name="insert-territory-partner" class="btn btn-primary">
                                <i class="material-icons">add</i> Add Territory Partner
                            </button>
