...
if($to_user_type=="distributor")
{
$selectRcd_VLSS1="select * from distributor where temp_id='$to_user_id'";
	...
	$mobilnumber=$resultRcd_VLSS1["mobile_number"];
										
}

else if($to_user_type=="customers")
{
$selectRcd_VLSS1="select * from customers where id='$to_user_id'";
	...
	$useridtext="Nil";
	$usernametext=$resultRcd_VLSS1["name"];
	$mobilnumber=$resultRcd_VLSS1["mobile"];
										
}
else{
	
	$selectRcd_VLSS1="select * from shop where temp_id='$to_user_id'";
										$fetchRcd_VLSS1=mysqli_query($db_conn,$selectRcd_VLSS1);
										$resultRcd_VLSS1=mysqli_fetch_array($fetchRcd_VLSS1);
