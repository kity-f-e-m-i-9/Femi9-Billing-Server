...
$displaytitle="Overall - Distributor's";
$tablename="distributor";
$xlurl="excel_distributor_users";
?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <table id="datatable1" class="table" style="width:100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        {
                                                        ?>
                                                            <a href="inactive_user?usr=distributor&backurl=overallusers&usrid=<?=$rowid;?>&usrname=<?=$encoded_name;?>&userlabel=Distributor" 
                                                               class="status-link" 
                                                        ...
                                                        {
                                                        ?>
                                                            <a href="active_user?usr=distributor&backurl=overallusers&usrid=<?=$rowid;?>&usrname=<?=$encoded_name;?>&userlabel=Distributor" 
                                                               class="status-link" 
                                                    ...
                                                    <!-------------------Update referral---------------------------------->
                                                    <?php if($result_referralDetails['ref_by_user_type']=="company" || $result_referralDetails['ref_by_user_type']==NULL){?>
                                                        <td class="text-center">---</td>
                                                        <td>
                                                            <div style="display:flex; align-items:center; gap:8px;">
                                                                <span>Company</span>
                                                                <a href="JavaScript:newPopup('update_referral_dt.php?distributorid=<?=$result_product_list['temp_id'];?>');">
                                                    ...
                                                    <!-- Edit Column -->
                                                    <td class="text-center">
                                                        <a href="distributor-edit?prid=<?php echo $rowid; ?>" 
                                                           class="edit-btn" 
