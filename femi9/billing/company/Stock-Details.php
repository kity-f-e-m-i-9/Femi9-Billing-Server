                                    ...
                                    <?php
                                        ...
                                        if($selected_state_id > 0) {
                                            ...
                                            if(!empty($stock_users)) {
                                                ...
                                                // per-warehouse rows — a product's stock can now be split
                                                // across physical godowns (H1/G1/G2), and without this the
                                                // PHP array below (keyed by product_id) would silently keep
                                                // only whichever warehouse row the DB returned last.
                                                $stock_detail_query = "
                                                    SELECT
                                                        user_type,
                                                        user_id,
