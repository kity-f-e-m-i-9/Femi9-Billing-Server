...
$select_records = "select * from stockiest where onboard_userTYPE='$onboard_userTYPE' and onboard_userID='$onboard_userID' order by id desc";
...
// Header row for CSV
$csv_content .= "ID, Name, State, District, Taluk, Email , Mobile Number, GSTIN, Address\n";
