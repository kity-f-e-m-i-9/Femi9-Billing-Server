...
if($GET_mapusertype!="company")
{
	...
	if($GET_mapusertype=="distributor"){$tblename="distributor"; $lablename="Distributor";}
...
<head>
    ...
    <!-- Title -->
    <title>Re-mapping : Shop Assigned to Distributor : <?php echo $business_name;?></title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<a href="remapping-dis" id="linkbackvl">&#8630;&nbsp;Go Back</a>
                                     <h2>
									<table class="headertble margintop10">
									<tr>
									<td>
									Re-mapping : <i><span style="color:green;">Shop</span></i> Assigned to <b><span style="color:green;">Distributor</span></b>
...
<?php 
$select_supersotkistCOUNT="select count(*) as numMAPP from shop where onboard_userTYPE='$onboardusertype' 
...
<form action="remapping-action" method="post" enctype="multipart/form-data" onSubmit="return confirm('Please make a confirm!');">
					...
					<?php 
					$select_supersotkist="select * from shop where onboard_userTYPE='$onboardusertype' 
...
<label for="exampleInputEmail1" class="form-label">Assigned To*</label>
				...
				<?php $select_stateList12="select * from distributor where temp_id!='$GET_mapuserid'";
						   ...
						   <option value="<?=$result_stateList12['temp_id'];?>"><?=strtoupper($result_stateList12['name']);?>, <?=$result_stateList12['mobile_number'];?></option>
							   <?php }?><br/>
												...
												<br/>
												<button type="submit" name="REMAPPING_SHOP" class="btn btn-primary"><i class="material-icons"></i>Submit</button>
