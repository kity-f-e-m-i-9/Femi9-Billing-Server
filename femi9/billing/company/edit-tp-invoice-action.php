...
// This invoice's type is fixed at creation (inherited from its PO, or
// chosen on a direct invoice) — editing can add/remove/change quantities,
// but never smuggle in a product of the other type.
...
try {
    ...
    // Company-side edit action — always scoped to this TP's company-approved
    // pool, same reasoning as tp-invoice-action.php.
    $editApprover = ['type' => 'company', 'ss_id' => null];
