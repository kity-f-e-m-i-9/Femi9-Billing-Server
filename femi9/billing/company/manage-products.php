                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['addesuccess'])){?><div class="alert alert-success">Product added success.</div><?php }?>
								...
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! one product deleted success.</div><?php }?>
									...
									<td><a href="Products" title="Add Product">&#10011;</a></td>
									<td><a href="export_products" title="Export"><img src="../../assets/images/excel-3-32.png"></a></td>
									</tr>
									</table>
									</h1>
                                </div>
										...
										while($result_product_list=mysqli_fetch_array($fetch_product_list))
										{
											...
											?>
                                                ...
                                                <tr>
													...
													<td><?php echo $result_product_list["purchase_price"] !== null ? '&#8377;'.$result_product_list["purchase_price"] : '—';?></td>
													<td><?php echo $result_product_list["purchase_price_per_piece"] !== null ? '&#8377;'.$result_product_list["purchase_price_per_piece"] : '—';?></td>
													<td>&#8377;<?php echo $result_product_list["mrp"];?>.00</td>
													
							<td>&#8377;<?php echo $result_product_list["supersstock_price"];?>.00</td>
							<td>&#8377;<?php echo $result_product_list["stockist_price"];?>.00</td>
							<td>&#8377;<?php echo $result_product_list["distributor_price"];?>.00</td>
							<td>&#8377;<?php echo $result_product_list["outlet_price"];?>.00</td>
							
							<td><?php echo $result_product_list["gst"];?>%</td>
							<td><?php echo ucfirst($result_product_list["gst_type"] ?? 'exclusive');?></td>
							<td><?php echo $result_product_list["hsn"];?></td>
							<td><?php echo $result_product_list["rwpoints"];?></td>
