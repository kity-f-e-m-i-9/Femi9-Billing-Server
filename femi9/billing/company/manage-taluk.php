                        ...
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! one <?php echo $message_title;?> deleted success.</div><?php }?>
									...
									<td><a href="export_taluk" title="Export"><img src="../../assets/images/excel-3-32.png"></a></td>
									</tr>
									</table>
									</h1>
                                </div>
                                        ...
                                        <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
                                            <thead>
											 ...
											 <tbody>
					<?php $select_product_list="select * from taluk order by id desc";
                                                ...
                                                <tr>
													...
													<td><?php echo $result_product_list['taluk'];?></td>
													    ...
													    <div class="actions-group">
													        <a href="edit-taluk?prid=<?php echo $row_id;?>" class="action-link" title="Edit"><i class="material-icons-outlined" style="font-size:17px;color:#667eea;">edit</i></a>
													        <a href="delete-taluk?prid=<?php echo $row_id;?>" class="action-link delete" title="Delete" onclick="return confirm('You want to delete confirm?');"><i class="material-icons-outlined" style="font-size:17px;color:#ef4444;">delete_outline</i></a>
													    </div>
													</td>
                                                </tr>
										<?php }?>
