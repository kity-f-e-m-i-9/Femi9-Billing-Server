...
<head>
    ...
    <title>DM Report : <?php echo $business_name; ?></title>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="page-description">
                                <h1>DM Report <small class="text-muted" style="font-size:13px;">(marketing staff assigned to your districts)</small></h1>
                            </div>
                        </div>
                    </div>
