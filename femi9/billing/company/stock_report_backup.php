...
?>
				...
				<!-------------------------------------------------------------------->
										...
										<?php }?>
										 ...
										 <?php 
$select_Sum_CLOSING_VLSS1="select sum(closing_qty) from stock where user_type='$usertype_stock'";
$fetch_Sum_CLOSING_VLSS1=mysqli_query($db_conn,$select_Sum_CLOSING_VLSS1);
$result_Sum_CLOSING_VLSS1=mysqli_fetch_array($fetch_Sum_CLOSING_VLSS1);
	?>
				<td style="text-align:right;"><b><?php echo $result_Sum_CLOSING_VLSS1[0]; ?></b></td>
										 </tr>
										 </tfoot>
										 <?php */?>
                                        </table>
...
?>
				...
				<!-------------------------------------------------------------------->
										 ...
										 <?php 
$select_Sum_CLOSING_VLSS2="select sum(closing_qty) from stock where user_type='$usertype_stock'";
$fetch_Sum_CLOSING_VLSS2=mysqli_query($db_conn,$select_Sum_CLOSING_VLSS2);
$result_Sum_CLOSING_VLSS2=mysqli_fetch_array($fetch_Sum_CLOSING_VLSS2);
	?>
				<td style="text-align:right;"><b><?php echo $result_Sum_CLOSING_VLSS2[0]; ?></b></td>
										 </tr>
										 </tfoot>
										<?php */?>
                                        </table>
...
?>
				...
				while($result_prdetails_header=mysqli_fetch_array($fetch_prdetails_header)){
					...
					$prid_header=$result_prdetails_header['id'];
					$tempid=$resultRcd_VLSS3['temp_id'];
				...
				<!-------------------------------------------------------------------->
										...
										<?php }?>
										 ...
										 <td colspan="6" style="text-align:right;">Grand Total</td>
										 <?php 
$select_Sum_CLOSING_VLSS3="select sum(closing_qty) from stock where user_type='$usertype_stock'";
$fetch_Sum_CLOSING_VLSS3=mysqli_query($db_conn,$select_Sum_CLOSING_VLSS3);
$result_Sum_CLOSING_VLSS3=mysqli_fetch_array($fetch_Sum_CLOSING_VLSS3);
	?>
				<td style="text-align:right;"><b><?php echo $result_Sum_CLOSING_VLSS3[0]; ?></b></td>
										 </tr>
										 </tfoot>
										 <?php */?>
