...
<head>
    ...
    <!-- Title -->
    <title>Cashback History : <?php echo $business_name;?></title>
...
<div id="searchbuttoncont">
<button type="button" onclick="Javascript:window.location='cashback_report';" style="margin-left:10px;" class="btn btn-primary"><i class="material-icons"></i>Reset</button>
</div>
                            ...
                            <div class="col">
                              ...
                              <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
				<?php 
				$select_product_list="select * from wallet_monthly_sls_report where commission_type='Cashback' and from_date between '$from_date' and '$to_date' order by id desc";
...
?>
					...
					<td><div style="width:300px;"><?=$result_product_list['remarks'];?></div></td>
