...
<head>
    ...
    <title>Marketing Team Levels : <?php echo $business_name; ?></title>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <?php if (isset($_REQUEST['hasStaff'])): ?>
                                <div class="alert alert-danger">Cannot delete: marketing staff are assigned to this level. Reassign them first.</div>
                            <?php endif; ?>
                            ...
                            <div class="page-description">
                                <h1>
                                    <table class="headertble">
                                        <tr>
                                            <td>Marketing Team Levels</td>
                                            <td>
                                                <a href="add-marketing-team-level" title="Add Level">&#10011;</a>
                                            </td>
                                        </tr>
                                    </table>
                                </h1>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="alert alert-info" style="font-size:13px;margin-bottom:0;">
                                ...
                                Define the marketing team hierarchy levels (e.g. Rank 1 = <strong>SM</strong>, Rank 2 = <strong>ASM</strong>, Rank 3 = <strong>DM</strong>).
                                Rank 1 is the top of the hierarchy. These levels appear as the "Team Level" option when adding or editing a marketing staff.
                            </div>
                        </div>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="actions-group">
                                                            <a href="edit-marketing-team-level?prid=<?php echo $enc_id; ?>" class="action-link" title="Edit"><i class="material-icons-outlined" style="font-size:17px;color:#667eea;">edit</i></a>
                                                            <?php if ($staff_cnt > 0): ?>
                                                            ...
                                                            <?php else: ?>
                                                                <a href="delete-marketing-team-level?prid=<?php echo $enc_id; ?>" class="action-link delete" title="Delete" onclick="return confirm('Delete level &quot;<?php echo addslashes(htmlspecialchars($level['level_name'])); ?>&quot;? This cannot be undone.');"><i class="material-icons-outlined" style="font-size:17px;color:#ef4444;">delete_outline</i></a>
                                                            <?php endif; ?>
                                                        </div>
                                                    </td>
                                                </tr>
