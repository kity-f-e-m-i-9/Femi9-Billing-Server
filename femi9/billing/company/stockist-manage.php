                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                ?>
                                    ...
                                    <td><a href="stockist-add" title="Add Stockist">&#10011;</a></td>
                                    <td><a href="export_stockist" title="Export"><img src="../../assets/images/excel-3-32.png"></a></td>
                                    </tr>
                                    </table>
                                    </h1>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div style="overflow-x:auto;">
                                            <table id="datatable1" class="table" style="width:100%;">
                                                ...
                                                <tbody>
                                                <?php 
                                                $select_product_list="select * from stockiest where onboard_userTYPE='company' and onboard_userID='company' order by id desc";
                                                ...
                                                while($result_product_list=mysqli_fetch_array($fetch_product_list))
                                                {
                                                    ...
                                                    $target_amount=$result_RFRDtailsCNG_CAT['target_amount'];
                                                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="info-text">
                                                            <strong>D:</strong> <?=ucwords($district_name);?><br/>
                                                            <strong>T:</strong> <?=ucwords($taluk_name);?><br/>
                                                            <strong>P:</strong> <?=$pincode_id;?>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        {
                                                        ?>
                                                            <a href="inactive_user?usr=stockiest&backurl=stockist-manage&usrid=<?=$rowid;?>&usrname=<?=$encoded_name;?>&userlabel=Stockist" 
                                                               class="status-link" 
                                                        ...
                                                        {
                                                        ?>
                                                            <a href="active_user?usr=stockiest&backurl=stockist-manage&usrid=<?=$rowid;?>&usrname=<?=$encoded_name;?>&userlabel=Stockist" 
                                                               class="status-link" 
                                                    ...
                                                    <td class="text-center info-text">
                                                        <strong><?=$Login_person_CAT?></strong><br/>
                                                        (&#8377;&nbsp;<?=$target_amount;?>)
                                                    </td>

                                                    <td class="text-center">
                                                        <a href="JavaScript:newPopup('stockist-details-ss?prid=<?php echo $rowid;?>&&actiondetails');" 
