...
<form action="stockist-action" method="post" enctype="multipart/form-data" id="uploadForm">
...
<!-------------------New add end-------->											
            ...
            <input type="text" required="" maxlength="50" name="name" class="form-control" onkeypress="restrictSpecialChars(event)">
			<br/>
...
xmlhttp.send();}
        ...
        <!-- New add end -->
            ...
            <input type="text" required="" name="mobile_number" class="form-control" onkeypress="restrictnumber(event)" pattern="[1-9]{1}[0-9]{9}" maxlength="10">-->
			<br/>
