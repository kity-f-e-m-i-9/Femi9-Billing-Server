                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info">
                                        ...
                                        <ol class="mb-2">
                                            <li>Download the sample Excel template below — it lists every active product as its own <strong>"&lt;Product&gt; Qty"</strong> / <strong>"&lt;Product&gt; Rate"</strong> column pair, generated fresh from your current product list.</li>
                                            ...
                                            <li>Products are matched to your catalog automatically by column, not by typing a name — Rate columns are pre-filled with each product's current price, which you can override per invoice.</li>
