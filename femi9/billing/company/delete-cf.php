...
//user details
$select_userdetails="select * from c_and_f where id='$prid'";
...
$del_product="delete from c_and_f where id='$prid'";
mysqli_query($db_conn,$del_product);

echo "<script>window.location='manage_cf?deletedDone';</script>";
?>