...
// A Sales BDM session may only view shops for marketing staff whose own
// assigned district falls inside their own assigned districts — same scope
// bdm-ms-shop-view.php already applies when building this link, re-checked
// here since ms_ids arrives as a tamperable GET param.
...
<head>
    ...
    <style>
        ...
        .mt-filter-bar { background:#fff; border:1px solid #e5e7eb; border-radius:10px; padding:16px 18px; margin-bottom:16px; }
        .mt-filter-bar .form-label { font-size:11px; font-weight:600; color:#6b7280; text-transform:uppercase; letter-spacing:.3px; }
    </style>
</head>
<body>
                                        ...
                                        <table id="datatable1" style="width:100%;">
                                            ...
                                            <?php $i = 0; foreach ($shops as $shop): $i++; ?>
                                                <tr>
                                                    ...
                                                    <td><span class="stat-pill"><?php echo (int)$shop['got_order_count']; ?></span></td>
                                                    <td><span class="stat-pill"><?php echo (int)$shop['no_order_count']; ?></span></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <?php if (empty($shops)): ?>
                                                <tr>
