...
$stmt = $db_conn->prepare("
    SELECT tap.*, tp.name AS tp_name, tp.tp_id AS tp_code, cg.gname AS receiver_name
...
<div class="info-note">
    ...
    <strong>Note:</strong> You can only edit payment details and amounts. TP and Receiver information cannot be changed.
</div>
...
<div class="edit-form-section">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><strong>Payer:</strong> <?php echo htmlspecialchars($payment['tp_name']); ?> (<?php echo htmlspecialchars($payment['tp_code']); ?>)</p>
        </div>
        <div class="col-md-6">
            <p><strong>Receiver:</strong> <?php echo htmlspecialchars($payment['receiver_name'] ?: '—'); ?></p>
        </div>
    </div>
</div>
