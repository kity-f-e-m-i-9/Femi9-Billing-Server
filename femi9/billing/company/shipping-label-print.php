...
// Default From (seller godown) / To (ship-to) address text — used only to
// seed a brand-new label row; once a row exists, editing it here never
// touches the row again (that's the point of it being editable).
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-description no-print" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;">
                        ...
                        <div style="display:flex;gap:8px;">
                            <a href="dispatch-slip-print.php?po_id=<?= (int)$po['id']; ?>" target="_blank" class="btn btn-outline-secondary btn-sm">Dispatch Slip</a>
                    ...
                    <p class="no-print" style="color:#6b7280;font-size:13px;margin-top:4px;">
                        Dispatch Slip's Box column says this shipment needs <b><?= $boxTotals['TotalBoxesDisplay']; ?></b>,
