...
$stmt_mx = $db_conn->query("SELECT COALESCE(MAX(level_rank), 0) + 1 AS next_rank FROM salesbdm_team_levels");
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-3" style="font-size:13px;">
                                        A team level defines a rung in the Sales BDM team hierarchy.
                                        Rank 1 is the top of the hierarchy.
                                    </p>
                                            ...
                                            <div class="example-content">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" required name="level_name"
                                                           class="form-control"
                                                           placeholder="e.g. Regional Head / BDM"
                                                           maxlength="50"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-muted">Staff at this level will only be assignable locations from this layer. Multiple levels can share the same layer &mdash; a subordinate level is then restricted to the specific locations their manager already holds within it. Only layers with "Sales BDM Filter Enabled" show here.</small>
                                                </div>

                                                <br>
                                                <button type="submit" name="insert-salesbdm-team-level" class="btn btn-primary">
