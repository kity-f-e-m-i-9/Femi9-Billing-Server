...
$title="Update State";
$manage_url="manage-state.php";
$manage_title="Manage State";
$message_title="State";
...
$select_product_list="select * from state where id='$prid'";
...
<input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                        ...
                                        <div class="example-container">
                                            <div class="example-content">
                                                ...
                                                <input type="text" required="" name="st_name" value="<?php echo $result_product_list["st_name"]?>" class="form-control" onkeypress="restrictSpecialChars(event)">
												
												<br/>
												
												<button type="submit" name="update-state" class="btn btn-primary">Update</button>
