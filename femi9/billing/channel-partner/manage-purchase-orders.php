...
<head>
    ...
    <style>
        ...
        .po-stat-card.teal    { border-color: #0d9488; } .po-stat-card.teal    .material-icons-outlined { color: #0d9488; }
...
<body>
            ...
            <div class="app-content">
                <div class="content-wrapper">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6">
                                <div class="po-stat-card teal">
                                    <div><h3 style="font-size:18px;">₹<?=number_format($headroom, 2)?></h3><p>Available Headroom</p></div>
                                ...
                                <table class="po-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="text-muted" style="font-size:12.5px;">Company</span></td>
                                            <td>
                                            ...
                                            <td>
                                                <button type="button" class="po-items-trigger items-view-trigger" data-items="<?=$items_json?>">
                                            ...
                                            <td>
                                                <div class="po-actions">
                                                    <button type="button" class="po-view-btn items-view-trigger" data-items="<?=$items_json?>" title="View order in detail">
    ...
    $(document).on('click', '.items-view-trigger', function () {
        ...
        $('#itemsViewModalLabel').html(
            '<i class="material-icons-outlined" style="font-size:18px;vertical-align:middle;margin-right:5px;color:#667eea;">inventory_2</i>Order Items'
        );
