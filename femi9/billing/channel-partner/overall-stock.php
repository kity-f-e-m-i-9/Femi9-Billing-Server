...
$stmt = $db_conn->prepare(
    "SELECT cps.input_qty, cps.closing_qty, p.productName
     FROM channel_partner_stock cps
     LEFT JOIN products p ON cps.product_id = p.id
                                        ...
                                        $(document).ready(function(){
                                            $('.popup-trigger').click(function(){
                                                ...
                                                $('#popup-content').html(
                                                    ...
                                                    "<p>Input Qty : <b>"     + tds.eq(1).text() + "</b></p>" +
                                                    "<p>Closing Qty : <b>"   + tds.eq(2).text() + "</b></p>"
                                                );
                                                $('#popup').fadeIn();
                                            });
