...
$stmt->close();
if (!$result_Invoice_Details) { header("Location: manage-tp-invoices.php"); exit; }
        ...
        <div class="app-container">
            ...
            <div class="app-content">
                ...
                <tr>
                    ...
                    <td><button type="button" onClick="javascript:window.location='manage-tp-invoices.php';" class="btn btn-primary m-b-xs m-r-xs">Manage Invoices</button></td>
                </tr>
                </table>
                <br/>
