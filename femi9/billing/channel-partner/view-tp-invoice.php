...
if (!$inv_id) { header("Location: manage-tp-invoices.php"); exit; }

// Restrict to invoices sourced from this CP's own stock
$stmt = $db_conn->prepare("
    ...
    WHERE tpi.id = ? AND tpi.source_cp_id = ?
");
$stmt->bind_param('ii', $inv_id, $cp_id);
$stmt->execute();
$inv = $stmt->get_result()->fetch_assoc();
$stmt->close();
if (!$inv) { header("Location: manage-tp-invoices.php"); exit; }
        ...
        <div class="app-content">
            <div class="content-wrapper">
                <div class="container-fluid">
                            ...
                            <div class="page-description">
                                <h1>
                                    <table class="headertble"><tr>
                                        <td>Invoice</td>
                                        <td><a href="manage-tp-invoices.php" title="All Invoices">&#9776;</a></td>
                                    </tr></table>
                                </h1>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-sm" style="font-size:13px;">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right" style="color:#64748b;">−₹<?php echo number_format($discount, 2); ?></td>
                                            </tr>
                                            <?php endif; ?>
                                            <?php if ($courier > 0): ?>
                                            <tr>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <a href="manage-tp-invoices.php" class="btn btn-secondary">
