...
if ($hasTps) {
    ...
    $_hdr = $db_conn->query("
        ...
        WHERE tpl.territory_partner_id IN ($tpIdList) AND (pll1.layer_name IS NOT NULL OR pll2.layer_name IS NOT NULL)
        LIMIT 1
    ");
...
<head>
    ...
    <title>Manage Territory Partner : <?php echo $business_name; ?></title>
    ...
    <style>
        ...
        .avatar-circle { width: 36px; height: 36px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; font-size: 14px; font-weight: 700; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; }
        ...
        .action-link { display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 6px; text-decoration: none; border: none; background: none; cursor: pointer; }
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                            ...
                            <div class="page-description">
                                <h1>
                                    <table class="headertble"><tr>
                                        ...
                                        <td><a href="add-tp" title="Add Territory Partner">&#10011;</a></td>
                                    </tr></table>
                                </h1>
                            </div>
                        </div>
                    ...
                    <?php if (isset($_REQUEST['addesuccess'])): ?>
                        <div class="alert alert-success">TP added successfully.</div>
                    <?php endif; ?>
                    <?php if (isset($_REQUEST['updatedSuccess'])): ?>
                        <div class="alert alert-success">TP updated successfully.</div>
                    <?php endif; ?>
                    <?php if (isset($_REQUEST['deletedDone'])): ?>
                        <div class="alert alert-success">TP deleted successfully.</div>
                    <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="stat-card purple"><div><h3><?php echo $total; ?></h3><p>Total Partners</p></div><i class="material-icons-outlined stat-icon">groups</i></div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="stat-card green"><div><h3><?php echo $active; ?></h3><p>Active</p></div><i class="material-icons-outlined stat-icon">check_circle</i></div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="stat-card red"><div><h3><?php echo $inactive; ?></h3><p>Inactive</p></div><i class="material-icons-outlined stat-icon">cancel</i></div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="stat-card blue"><div><h3><?php echo $total_locs; ?></h3><p>Locations Assigned</p></div><i class="material-icons-outlined stat-icon">location_on</i></div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="stat-card orange"><div><h3 style="font-size:20px;">&#8377;<?php echo inr_format($grand_target, 0); ?></h3><p>Total Target</p></div><i class="material-icons-outlined stat-icon">track_changes</i></div>
                        </div>
                    </div>

                    <div class="card">
                        <div class="card-header">
                            <span class="card-header-title"><i class="material-icons-outlined">people</i>Your Territory Partners</span>
                            <a href="add-tp" class="btn-add"><i class="material-icons" style="font-size:16px;">add</i> Add Partner</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="datatable1" style="width:100%;">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($tp['photo']): ?>
                                                    <img src="../company/tp_photo/<?php echo htmlspecialchars($tp['photo']); ?>" style="width:36px;height:36px;border-radius:50%;object-fit:cover;border:2px solid #e5e7eb;">
                                                <?php else: ?>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($tp['email']): ?><br><small style="color:#9ca3af;font-size:11.5px;"><?php echo htmlspecialchars($tp['email']); ?></small><?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                if ($gp_vals): foreach ($gp_vals as $_v): ?>
                                            ...
                                            <td>
                                                ...
                                                if ($p_vals): foreach ($p_vals as $_v): ?>
                                            ...
                                            <td>
                                                <?php $target = (float)$tp['total_target']; if ($target > 0): ?>
                                                    <span style="font-weight:600;color:#b45309;">&#8377;<?php echo inr_format($target, 2); ?></span>
                                                <?php else: ?>
                                                    <span style="color:#d1d5db;font-size:12px;">—</span>
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                <?php if ($tp['is_active']): ?><span class="badge-active">Active</span><?php else: ?><span class="badge-inactive">Inactive</span><?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="actions-group">
                                                    <a href="edit-tp?tpid=<?php echo $enc_id; ?>" class="action-link" title="Edit">
                                                    ...
                                                    <a href="delete-tp?tpid=<?php echo $enc_id; ?>"
...
<div class="modal fade" id="locViewModal" tabindex="-1" aria-labelledby="locViewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body" id="locViewModalBody" style="padding:16px 20px;"></div>
...
$(document).on('click', '.toggle-status-btn', function () {
    ...
    $.post('toggle-tp-status.php', {
        csrf_token: CSRF_TOKEN, id: id, status: newStatus
    }, function (res) {
