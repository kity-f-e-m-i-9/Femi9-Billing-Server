...
// Invoice header — restricted to a TP inside this BDM's own districts.
...
$stmt->close();
if (!$result_Invoice_Details) { header("Location: tp-purchase-order.php"); exit; }
        ...
        <div class="app-container">
            ...
            <div class="app-content">
                ...
                <tr>
                    ...
                    <td><button type="button" onClick="javascript:window.location='tp-purchase-order.php';" class="btn btn-primary m-b-xs m-r-xs">Purchase Orders</button></td>
                </tr>
                </table>
                <br/>
...
<td id="rightlaign"><b>&minus;<?= $Currency_symbol; ?>&nbsp;<?= inr_format($discount_amount, 2); ?></b></td>
</tr>
<?php endif; ?>
