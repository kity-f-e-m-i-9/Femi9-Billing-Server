...
<head>
    ...
    <title>Add Territory Partner : <?php echo $business_name; ?></title>
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <form action="tp-action.php" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="action" value="insert-tp">
                                        ...
                                        <div class="example-content">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tp_name" class="form-control" maxlength="100" required autofocus
                                                       value="<?php echo isset($_GET['tp_name']) ? htmlspecialchars($_GET['tp_name']) : ''; ?>">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Company Name <span class="text-danger">*</span></label>
                                                <input type="text" name="tp_company_name" class="form-control" maxlength="255" required
                                                       value="<?php echo isset($_GET['tp_company_name']) ? htmlspecialchars($_GET['tp_company_name']) : ''; ?>">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tp_mobile" class="form-control" maxlength="15"
                                                       ...
                                                       value="<?php echo isset($_GET['tp_mobile']) ? htmlspecialchars($_GET['tp_mobile']) : ''; ?>">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" name="tp_email" class="form-control" maxlength="100"
                                                       value="<?php echo isset($_GET['tp_email']) ? htmlspecialchars($_GET['tp_email']) : ''; ?>">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tp_gstin" class="form-control" maxlength="20"
                                                       value="<?php echo isset($_GET['tp_gstin']) ? htmlspecialchars($_GET['tp_gstin']) : ''; ?>">
                                            </div>
                                            ...
                                            <div class="row g-2 mb-3">
                                                <div class="col-12"><input type="text" name="tp_branch_line1" class="form-control" maxlength="255" placeholder="Line 1 (Building / Street) *" required></div>
                                                <div class="col-12"><input type="text" name="tp_branch_line2" class="form-control" maxlength="255" placeholder="Line 2 (Area / Landmark)"></div>
                                                <div class="col-6"><input type="text" name="tp_branch_city" class="form-control" maxlength="100" placeholder="City"></div>
                                                <div class="col-6"><input type="text" name="tp_branch_district" class="form-control" maxlength="100" placeholder="District"></div>
                                                <div class="col-6"><input type="text" name="tp_branch_state" class="form-control" maxlength="100" placeholder="State"></div>
                                                <div class="col-6"><input type="text" name="tp_branch_country" class="form-control" maxlength="100" placeholder="Country"></div>
                                                <div class="col-6"><input type="text" name="tp_branch_pincode" class="form-control" maxlength="20" placeholder="Pincode"></div>
                                            </div>
                                            ...
                                            <div class="row g-2 mb-3">
                                                <div class="col-12"><input type="text" name="tp_delivery_line1" id="tp_delivery_line1" class="form-control" maxlength="255" placeholder="Line 1 (Building / Street) *" required></div>
                                                <div class="col-12"><input type="text" name="tp_delivery_line2" id="tp_delivery_line2" class="form-control" maxlength="255" placeholder="Line 2 (Area / Landmark)"></div>
                                                <div class="col-6"><input type="text" name="tp_delivery_city" id="tp_delivery_city" class="form-control" maxlength="100" placeholder="City"></div>
                                                <div class="col-6"><input type="text" name="tp_delivery_district" id="tp_delivery_district" class="form-control" maxlength="100" placeholder="District"></div>
                                                <div class="col-6"><input type="text" name="tp_delivery_state" id="tp_delivery_state" class="form-control" maxlength="100" placeholder="State"></div>
                                                <div class="col-6"><input type="text" name="tp_delivery_country" id="tp_delivery_country" class="form-control" maxlength="100" placeholder="Country"></div>
                                                <div class="col-6"><input type="text" name="tp_delivery_pincode" id="tp_delivery_pincode" class="form-control" maxlength="20" placeholder="Pincode"></div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tp_password" class="form-control" maxlength="100" value="Partner@123" readonly>
                                                <small class="text-muted">Default password for territory partner login.</small>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <p class="text-muted mb-3" style="font-size:13px;">
                                        ...
                                        Select the location(s) this TP will manage, within your own districts.
                                    </p>
                    ...
                    <div class="row mt-1 mb-3">
                        <div class="col">
                            <button type="submit" class="btn btn-primary"><i class="material-icons">add</i> Add Territory Partner</button>
...
(function ($) {
    ...
    function loadNodes() {
        ...
        $.getJSON('get-tp-flat-nodes.php', function (nodes) {
            allNodes = nodes;
            loaded = true;
            renderList($.trim($('#lpSearchInput').val()));
        }).fail(function () {
