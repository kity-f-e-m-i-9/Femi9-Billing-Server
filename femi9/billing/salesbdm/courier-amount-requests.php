...
$pendingCount = 0;
if ($hasTps) {
    $pendingCount = (int)($db_conn->query("SELECT COUNT(*) c FROM tp_courier_amount_requests WHERE territory_partner_id IN ($tpIdList) AND status = 'pending'")->fetch_assoc()['c'] ?? 0);
...
<head>
    ...
    <title>Courier Amount Requests : <?php echo $business_name; ?></title>
        ...
        <div class="app-content">
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="car-tabs">
                        <?php
                        $tabQs = fn($st) => '?status=' . urlencode($st) . '&from_date=' . urlencode($filter_from) . '&to_date=' . urlencode($filter_to);
                        ?>
                        ...
                        <div class="card-body" style="overflow-x:auto;">
                            <table class="mt">
                                ...
                                <?php if (empty($requests)): ?>
                                    <tr><td colspan="9" class="text-center text-muted" style="padding:24px;">No requests found for this filter.</td></tr>
                                <?php else: foreach ($requests as $r): ?>
                                    <tr id="carRow<?php echo $r['id']; ?>">
                                        ...
                                        <td style="max-width:220px;white-space:normal;"><?php echo $r['note'] ? htmlspecialchars($r['note']) : '<span class="text-muted">&mdash;</span>'; ?></td>
                                        ...
                                        <td style="font-size:11.5px;">
                                            <?php if ($r['reviewed_by_name']): ?>
                                                ...
                                                <?php if ($r['status']==='approved'): ?><br><b>&#8377;<?php echo number_format($r['approved_amount'],2); ?></b><?php endif; ?>
                                            <?php else: ?>
