...
} catch (Exception $_e) { /* column not yet created */ }
        ...
        <div class="app-content">
            <div class="content-wrapper">
                <div class="container-fluid">
                                ...
                                <h1>
                                    <table class="headertble">
                                        <tr>
                                            ...
                                            <td><a href="manage-tp" title="Manage Territory Partner">&#9776;</a></td>
                                        </tr>
                                    </table>
                                </h1>
                            </div>
                    ...
                    <form action="tp-action.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                        <input type="hidden" name="action" value="update-tp">
                                    ...
                                    <div class="example-container">
                                        <div class="example-content">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tp_name" class="form-control" maxlength="100" required value="<?php echo htmlspecialchars($tp['name']); ?>">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Company Name <span class="text-danger">*</span></label>
                                                <input type="text" name="tp_company_name" class="form-control" maxlength="255" required value="<?php echo htmlspecialchars($tp['company_name'] ?? ''); ?>">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tp_referral_id" id="referralUserSelect" class="form-control" style="width:100%;">
                                                    ...
                                                    <?php if ($referral_preselect): ?>
                                                        <option value="<?php echo htmlspecialchars($referral_preselect['uid']); ?>" data-user-type="<?php echo htmlspecialchars($referral_preselect['utype']); ?>" selected><?php echo htmlspecialchars($referral_preselect['name']); ?></option>
                                                    <?php endif; ?>
                                                </select>
                                                <input type="hidden" name="tp_referral_type" id="referralTypeHidden" value="<?php echo htmlspecialchars($tp['referral_type'] ?? ''); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tp_referral_percentage" id="referralPctSelect" class="form-control" style="width:100%;">
                                                    <option value=""></option>
                                                    <?php
                                                    $saved_pct = isset($tp['referral_percentage']) && $tp['referral_percentage'] !== null ? (string)(float)$tp['referral_percentage'] : '';
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tp_mobile" class="form-control" maxlength="15" pattern="[0-9]{10,15}" required value="<?php echo htmlspecialchars($tp['mobile']); ?>">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Email <span class="text-muted" style="font-size:12px;">(optional)</span></label>
                                                <input type="email" name="tp_email" class="form-control" maxlength="100" value="<?php echo htmlspecialchars($tp['email'] ?? ''); ?>">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">GST Number <span class="text-muted" style="font-size:12px;">(optional)</span></label>
                                                <input type="text" name="tp_gstin" class="form-control" maxlength="20" value="<?php echo htmlspecialchars($tp['gstin'] ?? ''); ?>">
                                            </div>
                                            ...
                                            <div class="row g-2 mb-3">
                                                <div class="col-12"><input type="text" name="tp_branch_line1" class="form-control" maxlength="255" placeholder="Line 1 (Building / Street) *" required value="<?php echo htmlspecialchars($tp['branch_line1'] ?? ''); ?>"></div>
                                                <div class="col-12"><input type="text" name="tp_branch_line2" class="form-control" maxlength="255" placeholder="Line 2 (Area / Landmark)" value="<?php echo htmlspecialchars($tp['branch_line2'] ?? ''); ?>"></div>
                                            ...
                                            <div class="mb-1 d-flex align-items-center gap-2">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-secondary ms-2" id="copyBranchToDelivery" style="font-size:11px;padding:2px 8px;"><i class="material-icons" style="font-size:13px;vertical-align:middle;">content_copy</i> Same as Billing</button>
                                            </div>
                                            <div class="row g-2 mb-3">
                                                <div class="col-12"><input type="text" name="tp_delivery_line1" id="tp_delivery_line1" class="form-control" maxlength="255" placeholder="Line 1 (Building / Street) *" required value="<?php echo htmlspecialchars($tp['delivery_line1'] ?? ''); ?>"></div>
                                                <div class="col-12"><input type="text" name="tp_delivery_line2" id="tp_delivery_line2" class="form-control" maxlength="255" placeholder="Line 2 (Area / Landmark)" value="<?php echo htmlspecialchars($tp['delivery_line2'] ?? ''); ?>"></div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <?php if ($tp['photo']): ?>
                                                    <div class="mb-2"><img src="../company/tp_photo/<?php echo htmlspecialchars($tp['photo']); ?>" style="width:52px;height:52px;border-radius:6px;object-fit:cover;border:1px solid #e0e0e0;"></div>
                                                <?php endif; ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <p class="text-muted mb-3" style="font-size:13px;">
                                        ...
                                        Select the location(s) this partner will manage, within your own districts.
                                    </p>
                                    <div class="mb-3">
                                        ...
                                        <div class="lp-wrapper" id="locationPickerWrapper">
                                            <div class="lp-control" id="locationPickerControl">
                                                <div class="lp-value" id="lpValue"><span class="lp-placeholder">Select locations&hellip;</span></div>
                    ...
                    <div class="row mt-1 mb-3">
                        <div class="col">
                            ...
                            <a href="manage-tp" class="btn btn-secondary ms-2">Cancel</a>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    function formatResult(item) {
        ...
        return $('<div style="line-height:1.3;padding:2px 0;">' + badge + '<strong>' + $('<span>').text(item.text).html() + '</strong>' + ' <small style="color:#888;">(' + $('<span>').text(item.id).html() + ')</small></div>');
    }
    function formatSelection(item) {
        if (!item.id) return item.text;
        var utype = item.user_type || $(item.element).data('user-type') || '';
        var badge = typeBadge[utype] || '';
        return $('<span>' + badge + $('<span>').text(item.text).html() + ' <small style="color:#888;">(' + $('<span>').text(item.id).html() + ')</small></span>');
    }

    $('#referralUserSelect').select2({
        placeholder: 'Search by name, ID or mobile…', allowClear: true, minimumInputLength: 2,
        ajax: {
            url: 'search-referral-user.php', dataType: 'json', delay: 300,
    ...
    $('#referralUserSelect').on('select2:select', function (e) { $('#referralTypeHidden').val(e.params.data.user_type || ''); });
    $('#referralUserSelect').on('select2:clear', function () { $('#referralTypeHidden').val(''); });

    $('#referralPctSelect').select2({
        placeholder: 'Select or type a percentage…', allowClear: true, tags: true,
        ...
        templateResult: function (item) {
            return item.newTag ? $('<span style="color:#2563eb;">+ Add <strong>' + item.text + '</strong></span>') : item.text;
        }
    });
});
</script>
