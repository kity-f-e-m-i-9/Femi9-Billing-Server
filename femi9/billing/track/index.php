...
<head>
    ...
    <style>
        ...
        .eye-icon { position: absolute; right: 10px; top: 70%; transform: translateY(-50%); cursor: pointer; }
    </style>
</head>
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            ?>
                ...
                <script>
                    Swal.fire({ icon: 'error', title: 'Login Failed', text: '<?php echo $errorMessage; ?>', confirmButtonText: 'OK' });
                </script>
            <?php
            ...
            <form method="POST" action="CheckLogin.php" id="loginForm">
                ...
                <div class="auth-credentials m-b-xxl">
                    <div class="mb-3">
                        ...
                        <input type="text" required class="form-control" id="signInEmail" name="signInEmail"
                               autocomplete="username" pattern="[0-9]{10}" maxlength="10" placeholder="Enter 10-digit mobile number">
                    </div>

                    <div class="mb-3 password-container">
                        <label class="form-label">Password</label>
                        <input type="password" id="password" required autocomplete="current-password"
                               class="form-control" name="signInPassword" placeholder="Enter your password">
