...
$select_count_product="select * from input_stock_users where id='$Roowid'";
	...
	{
		//update stock
		$select_stockDetails="select * from stock where product_id='$product_id' and user_type='$user_type_Loginvl' and user_id='$user_id_Loginvl'";
		...
		$update_stockDetails="update stock set input_qty='$update_Input_stock',closing_qty='$update_Closing_stock' where product_id='$product_id' and user_type='$user_type_Loginvl' and user_id='$user_id_Loginvl'";
