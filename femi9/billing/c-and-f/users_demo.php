...
<table id="datatable1">
											...
											<tbody>
<?php
$select_product_list="select * from demo_awareness where ssid='$Login_user_IDvl' order by date desc";
...
if($usertype=="super_stockiest"){ $tablename="super_stockiest";  $disusertype="Super Stockist";}
else if($usertype=="stockiest"){ $tablename="stockiest"; $photourl="stockist"; $disusertype="Stockist";}
else{ $tablename="distributor"; $photourl="distributor"; $disusertype="Distributor";}

$select_Userdetails="select * from ".$tablename." where temp_id='".$result_product_list['userid']."'";
...
?>
					...
					<?php if($taluk_name!=NULL){?><br/>T:&nbsp;<?php echo $taluk_name; } ?>
					</td>
