...
$select_count_invoice_thismonth2="select count(*) as numinvcntcus from invoice where date between '$start_date' and '$endDate' and user_type='$Login_user_TYPEvl' and sub_total>0 and user_id='$Login_user_IDvl'";
