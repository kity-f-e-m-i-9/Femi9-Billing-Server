...
<?php  unset($_SESSION['successMessage']); } ?>
								...
								<?php if(isset($_REQUEST['MobileUpdatedSuccess'])){?><div class="alert alert-success">New mobile number updated success.</div><?php }?>
									...
									<td><a href="add_sust" title="Add Super Stockist">&#10011;</a></td>
									<td><a href="#export_sust" title="Export"><img src="../../assets/images/excel-3-32.png"></a></td>
									</tr>
									</table>
									</h1>
                                </div>
                            ...
                            <div class="col">
                              ...
                              <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
				<?php $select_product_list="select * from super_stockiest where onboard_userTYPE='$onboard_userTYPE' and onboard_userID='$onboard_userID' order by id desc";
...
$district_name=	$result_district['dist_name'];
					...
					<?php /*?>
					<!----<td>
					<a href="JavaScript:newPopup('update-username.php?pageNme=superstockist&&prid=<?php echo $rowid;?>&&ActionUpdate');" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Username">
			        <b><?php echo $result_product_list["username"];?></b></a>
					</td>----->
			...
			{
			?>
			<a href="inactive_user?usr=super_stockiest&&backurl=manage_sust&&usrid=<?=$rowid;?>&&usrname=<?=base64_encode($result_product_list["name"]);?>&&userlabel=Super Stockist" onclick="return confirm('You want to confirm Deactivate this (<?php echo strtoupper($result_product_list["name"]);?>)  user?');" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Deactivate user"><span class='badge badge-style-bordered badge-success'>Active</span></a>
			<?php
			}else{
				?>
				<a href="active_user?usr=super_stockiest&&backurl=manage_sust&&usrid=<?=$rowid;?>&&usrname=<?=base64_encode($result_product_list["name"]);?>&&userlabel=Super Stockist" onclick="return confirm('You want to confirm Activate this (<?php echo strtoupper($result_product_list["name"]);?>)  user?');" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Activate user"><span class='badge badge-style-bordered badge-danger'>Deactive</span></a>
...
<td>
			<a href="JavaScript:newPopup('details-sust.php?prid=<?php echo $rowid;?>');" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
...
function newPopup(url) {
	popupWindow = window.open(
		url,'popUpWindow','height=450,width=750,left=350,top=200,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes')
			...
			<td>
			<a href="edit-sust.php?prid=<?php echo $rowid;?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Details">
			<img src="../../assets/images/edit-32.png"/></a>
			</td>
													
	<td>
	<a href="delete-sust.php?prid=<?php echo $rowid;?>"onclick="return confirm('You want to delete confirm?');" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Details"><img src="../../assets/images/delete-32.png"/></a>
	</td>
                                                </tr>
