...
$select_records = "select * from ".$tablename." where valid_from between '$from_date' and '$to_date' and onboard_userTYPE='$Login_user_TYPEvl' and onboard_userID='$Login_user_IDvl' order by id asc";
