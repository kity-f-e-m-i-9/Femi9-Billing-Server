...
<head>
    ...
    <!-- Title -->
    <title>Overview Shop : <?php echo $business_name;?></title>
                            ...
                            <div class="col">
                              ...
                              <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
				<?php $select_product_list="select * from shop order by id desc";
...
$select_ssDetails="select * from distributor where temp_id='".$result_product_list['onboard_userID']."'";
