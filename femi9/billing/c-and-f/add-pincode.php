...
<form action="product-action.php" method="post" enctype="multipart/form-data" onSubmit="return confirm('Please make a confirm!')">
...
<label for="exampleInputEmail1" class="form-label">State Name</label>
							   ...
							   <option value="<?php echo $loguser_StateID;?>" hidden=""><?php echo $loguser_StateNAME;?></option>
							   </select>
												...
												<option value="<?php echo $loguser_DistrictID;?>" hidden=""><?php echo $loguser_DistrictNAME;?></option>
												</select>
												</div>
		...
		<?php $select_Taluk_list12="select * from taluk where state_id='$loguser_StateID' and dist_id='$loguser_DistrictID' order by taluk asc";
										$fetch_Taluk_list12=mysqli_query($db_conn,$select_Taluk_list12);
										while($Result_Taluk_list12=mysqli_fetch_array($fetch_Taluk_list12))
										{
											?>
											<option value="<?php echo $Result_Taluk_list12['id'];?>"><?php echo $Result_Taluk_list12['taluk'];?></option>
										<?php }?>
												</select>
				...
				<table id="dataTable" border="0">
                    <tr>
						<td><input type="checkbox" name="chk[]"/></td>
						 <td>
						 <input type="text" maxlength="15" class="form-control" name="pincode[]" required="required" placeholder="Pincode" onkeypress="restrictpincode(event)"/>
					     </td>
                    </tr>
                </table>
