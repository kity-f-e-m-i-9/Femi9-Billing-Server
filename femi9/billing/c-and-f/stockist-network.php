...
.users-networks-head td{font-size:13px;font-weight:bold;border:1px solid #000;padding:4px;}
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<a href="users-network2" id="linkbackvl">&#8630;&nbsp;Go Back</a>
                                    <h1>
									<table class="headertble">
									<tr>
									<td><?php echo $title;?> - Stockist</td>
									</tr>
									</table>
									</h1>
                                </div>
...
<tr><td colspan="3"><a href="distributor-network.php?superid=<?=$superstockistid;?>&&stockistid=<?=$result_product_list['temp_id'];?>" title="<?php echo strtoupper($result_product_list["name"]);?>"><div class="bottom-arrow"></div></a><br/></td></tr>
</tbody>
