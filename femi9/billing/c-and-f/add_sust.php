                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['distalready'])){?><div class="alert alert-danger">this districtwise super stockiest already exists.</div><?php }?>
...
<form action="sust-action" method="post" enctype="multipart/form-data" id="uploadForm">
