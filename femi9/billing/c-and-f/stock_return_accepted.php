                                ...
                                <div class="card">
									...
									<div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
					<?php $select_product_list="select * from user_return_stock where to_usertype='$Login_user_TYPEvl' and to_userid='$Login_user_IDvl' and status='accept' order by id desc";
