...
/*onChange="showPincode(<?php echo $stateid;?>,<?php echo $districtid;?>,this.value)"*/
?>

 <select required="" name="taluk_id" class="form-control">
 <option value="" hidden="">Select</option>
	<?php $select_taluk_list="select * from taluk where state_id='$stateid' and dist_id='$districtid' and assigned_SID='Nil' order by taluk asc";
