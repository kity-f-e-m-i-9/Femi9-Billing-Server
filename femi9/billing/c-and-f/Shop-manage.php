                            ...
                            <div class="col">
                              ...
                              <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
<?php $select_product_list="select * from shop where onboard_userTYPE='$onboard_userTYPE' and onboard_userID='$onboard_userID' order by id desc";
...
$pincodeshow=$pincode_id;
					...
					$imgsrcname="../distributor/".$result_product_list["user_icon"]."";
					}
					else
...
$shopcat_name=$result_shopcatt['catlable'];
                    ...
                    <td><?php echo ++$i; ?></td>
                    <td>
					 <a data-fslightbox="gallery" href="<?php echo $imgsrcname;?>">
                 View&nbsp;Photo
                                                    </a>
													</td>
					<td><?=$shopcat_name;?></td>
					...
					<td><?=ucwords($district_name);?></td>
					<td><?=ucwords($taluk_name);?></td>
					<td><?=$pincodeshow;?></td>
					
					<td><?php echo $result_product_list["country_code"];?>&nbsp;<?php echo $result_product_list["mobile_number"];?></td>
					<td><?php echo $result_product_list["landline"];?></td>
					
					<!-----<td>
			<a href="details-shop.php?prid=<?php echo $rowid;?>&&actiondetails" data-bs-toggle="tooltip" data-bs-placement="top" title="View Details">
			<img src="../../assets/images/details-32.png"/></a>
			</td>----->
			
			<td>
			<a href="Shop-edit.php?prid=<?php echo $rowid;?>&&actionupdate" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Details">
			<img src="../../assets/images/edit-32.png"/></a>
			</td>
													
	<!-------<td>
	<a href="Shop-delete.php?prid=<?php echo $rowid;?>&&actionremove"onclick="return confirm('You want to delete confirm?');" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Details"><img src="../../assets/images/delete-32.png"/></a>
	</td>----->
                                                </tr>
