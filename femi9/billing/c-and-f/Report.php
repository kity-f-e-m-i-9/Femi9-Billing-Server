           ...
           <?php include("app-header.php");?>
            ...
            <div class="app-content">
				...
				<?php include("report_onboarded.php"); ?>
						...
						<a href="stock_report?modelval=usr1&&out1=<?=base64_encode($Totalstock_VLSUST_Show)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">SS</span>
                                                <span class="widget-stats-amount"><?=$Totalstock_VLSUST_Show;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
						...
						<a href="overview_outstanding?modelval=usr1&&out1=<?=base64_encode($Total__SUSToutstanding)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">SS</span>
                                                <span class="widget-stats-amount"><?=$Total__SUSToutstanding;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
						...
						<a href="overview_outstanding?modelval=usr2&&out1=<?=base64_encode($Total_ST_outstanding)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Stockist</span>
                                                <span class="widget-stats-amount"><?=$Total_ST_outstanding;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
						...
						<a href="overview_outstanding?modelval=usr3&&out1=<?=base64_encode($Total_DT_outstanding)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Distributors</span>
                                                <span class="widget-stats-amount"><?=$Total_DT_outstanding;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
						...
						<a href="overview_outstanding?modelval=usr4&&out1=<?=base64_encode($Total_SHP_outstanding);?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                ...
                                                <span class="widget-stats-amount"><?=$Total_SHP_outstanding;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
