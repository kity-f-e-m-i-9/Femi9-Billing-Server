                        ...
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! one product deleted success.</div><?php }?>
									...
									<td><a href="Products.php" title="Add Product">&#10011;</a></td>
									</tr>
									</table>
									</h1>
                                </div>
										...
										while($result_product_list=mysqli_fetch_array($fetch_product_list))
										{
											...
											?>
                                                ...
                                                <tr>
													...
													<td>
													<a href="edit-product.php?prid=<?php echo $product_id;?>"><img src="../../assets/images/edit-32.png"/></a>
													</td>
													<td>
													<a href="delete-product.php?prid=<?php echo $product_id;?>"onclick="return confirm('You want to delete confirm?');"><img src="../../assets/images/delete-32.png"/></a>
													</td>
                                                </tr>
