...
$select_product_list="select * from demo_awareness where id='$get_id'";
...
<form action="demo_action.php" method="post" enctype="multipart/form-data">

<input type="hidden" name="update_id" value="<?=$result_product_list['id'];?>">
<input type="hidden" name="old_photo" value="<?=$imgsrcname;?>">

                                        <div class="example-container">
                                            <div class="example-content">
											
           <label class="form-label">Demo Title*</label>
            <input type="text" required="" value="<?=$result_product_list['title'];?>" onkeypress="restrictSpecialChars(event)" name="title" class="form-control">
			<br/>
			
			<label class="form-label">Demo Photo *</label>
            <input type="file" name="photo" id="fileUpload" accept=".jpg, .jpeg, .png" class="form-control">
			<br/>
			<img src="<?=$imgsrcname;?>" style="width:250px;border-radius:10px;">
	
	<div style="clear:both;"></div>
	<br/>
	<button type="submit" name="UPDATEDEMO" class="btn btn-primary">
