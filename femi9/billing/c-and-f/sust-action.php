...
{
	echo "<script>window.location='add_sust?InvalidMobileNumber';</script>";
...
echo "<script>window.location='manage_sust?addedsuccess';</script>";


}else{
		//this districtwise super stockiest already exists.
		echo "<script>window.location='add_sust?distalready';</script>";
	}
	
	
	}//count mobile number end ****
	
	}else{echo "<script>window.location='add_sust?invalidparameters';</script>";}
