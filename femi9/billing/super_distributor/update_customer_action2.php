...
{
	echo "<script>window.location='update_customer2?invuser=$invuser&&InvoiceID=$invid&&alreadyexists';</script>";
...
//------------------------------------------------------------------	
	...
	echo "<script>window.location='update_customer2?invuser=$invuser&&InvoiceID=$invid&&updatedsuccess';</script>";
