...
<input type="hidden" name="super_stockiest_id" value="<?php echo $loguser_tempid;?>"/>
   ...
   <br/>
				...
				<button type="button" class="btn btn-primary btn-burger" onClick="addRow('dataTable')"><i class="material-icons">add</i></button>     
				 ...
				 <table id="dataTable" border="0">
                    <tr>
						<td>
					<input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="chk[]"/></td>
						 <td>
							<input type="text" name="taluk[]" required="required" placeholder="Taluk" class="form-control"/>
					     </td>
                    </tr>
                </table>
