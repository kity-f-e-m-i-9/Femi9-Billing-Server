...
xmlhttp.send();}
                                                ...
                                                <select name="dist_id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onchange="showtaluk(this.value)">
										...
										<?php }?>
												...
												<option value="<?php echo $taluk_id;?>" hidden=""><?php echo $talulk_name;?></option>
												</select></div>
