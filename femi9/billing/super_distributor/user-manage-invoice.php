                        ...
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! one Invoice details deleted success.</div><?php }?>
									...
									<tr>
									<td><?=$displaytitle;?></td>
									<td><a href="user-invoice-add?invuser=<?=$_REQUEST['invuser'];?>" title="Add Invoice">&#10011;</a></td>
									</tr>
									</table>
									</h1>
                                </div>
...
<?php }?>
													...
													<td>
<a href="user-invoice-add?invuser=<?=$getinvuser;?>&&action=edit&&InvoiceID=<?php echo $INVID_encode;?>" title="Edit"><img src="../../assets/images/edit-32.png"/></a>
													</td>
													
													<!----<td>
<a href="#" onclick="return confirm('You want to delete confirm?');" title="Delete">
