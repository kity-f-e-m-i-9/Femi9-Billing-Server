                                ...
                                <div class="card">
									...
									<?PHP if($_REQUEST['modelval']=="usr2"){?>
                                        <table class="table">
											...
											<tbody>
										<?php $selectRcd_VLSS2="select * from ".$tblenma." where onboard_userTYPE='$Login_user_TYPEvl' and onboard_userID='$Login_user_IDvl' order by id asc";
...
?>
				...
				<td style="text-align:right;"><b><?=$Total_available_stock123_VLSS2;?></b></td>
										 </tr>
										 </tfoot>
                                        </table>
										<?PHP }?>
									...
									<?PHP if($_REQUEST['modelval']=="usr3"){?>
                                        <table class="table">
											...
											<tbody>
										<?php $selectRcd_VLSS3="select * from ".$tblenma." where onboard_userTYPE='$Login_user_TYPEvl' and onboard_userID='$Login_user_IDvl' order by id asc";
...
?>
				...
				<td style="text-align:right;"><b><?=$Total_available_stock123_VLSS3;?></b></td>
										 </tr>
										 </tfoot>
                                        </table>
									<?PHP }?>
