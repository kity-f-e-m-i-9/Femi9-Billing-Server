...
$select_UserdETAILS="select * from super_distributor where temp_id='$Login_user_IDvl'";
        ...
        <div class="app-container">
          <?php include("app-header.php");?>
           ...
           popupWin.document.close();}
			...
			<td><button type="button" onClick="javascript:window.location='shop-user-invoice-add.php?invuser=<?=$getinvuser;?>';" class="btn btn-success m-b-xs m-r-xs">+ New Invoice</button></td>
			<td><button type="button" onClick="javascript:window.location='shop-user-manage-invoice.php?invuser=<?=$getinvuser;?>';" class="btn btn-primary m-b-xs m-r-xs">Manage Invoice</button></td>
			</tr>
			</table>---->
...
<br/>
<button type="button" onClick="javascript:window.location='shop-user-invoice-add.php?invuser=<?=$getinvuser;?>';" class="btn btn-success m-b-xs m-r-xs" id="butonwidth">+ New Invoice</button>
...
<?php }?>
    ...
    document.getElementById("currencySelect").addEventListener("change", function() {
        ...
        if (selectedValue) {
            window.location.href = "shop-user-invoice-print?invoiceid=<?=$_REQUEST['invoiceid'] ?>&crcode=" + selectedValue;
        }
    });
</script>
<!------------Currency end ***---------->
...
<?php echo ucwords($result_Customer_Details['address']);?><br/>
<?php if($result_Customer_Details['gstin']!=NULL){?>
