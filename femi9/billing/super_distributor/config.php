...
define('CURRENT_USER_TYPE', 'super_distributor');
...
$select_LoGuserDtails="select * from super_distributor where username='".$_SESSION['LOGIN_USER']."'";
$fetch_LoGuserDtails=mysqli_query($db_conn,$select_LoGuserDtails);
$result_LoGuserDtails=mysqli_fetch_array($fetch_LoGuserDtails);

$Login_user_TYPEvl="super_distributor"; // user type
$Login_user_IDvl=$result_LoGuserDtails['temp_id']; // user id

$DummyStockistID="DMYSTKST/SDSTR/003";
$DummyDistributorID="DMYDSTBTRS/SDSTR/003";

$onboard_userTYPE="super_distributor";
...
$select_RFRDtailsCNG="select * from super_distributor_referral where sd_id='$Login_user_IDvl'";
...
$select_RFRDtailsCNG_CAT="select * from super_distributor_category where amount='$target_amount'";
