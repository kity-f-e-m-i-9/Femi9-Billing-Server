...
$userType = 'super_distributor'; // Change based on user type
...
.scroll-horizontal {
  ...
  @keyframes scroll-horizontal {
    ...
    <meta name="apple-mobile-web-app-title" content="Femi9 Super Dist.">
...
<h3><?=ucwords($result_top_performers['particulars']);?></h3>		
      ...
      <a data-fslightbox="gallery" href="../company/top_performers_photo/<?=$result_top_performers['per_photo'];?>" title="<?=ucwords($result_top_performers['particulars']);?>">
		...
		if($st_ref_type=="company")
		{
			...
			ref_by_user_id='company',updated='1' where sd_id='$stockist_id'";
			...
			if($st_ref_type=='super_distributor' && $Login_user_useridtext==$st_ref_userid_conc)
			{
		...
		if($result_count_REFERID==1)
		{
							...
							$UPDATE_REFERED="update super_distributor_referral set ref_by_user_type='$st_ref_type',ref_by_user_id='$st_ref_userid_conc',updated='1' where sd_id='$stockist_id'";
							mysqli_query($db_conn,$UPDATE_REFERED);
