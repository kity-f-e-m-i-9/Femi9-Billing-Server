...
//---------------------------------------------------------------------------------
//Today Invoice Count
$select_count_invoice_today="select count(distinct inv_id) as numinvoicetdy from user_invoice where date='$today_date' and from_user_type='$Login_user_TYPEvl' and sub_total>0";
...
//Today Product Qty
$select_prqty_today="select sum(qty) from user_invoice_items where date='$today_date' and from_user_type='$Login_user_TYPEvl'";
$fetch_prqty_today=mysqli_query($db_conn,$select_prqty_today);
$result_prqty_today=mysqli_fetch_array($fetch_prqty_today);

$select_prqty12_today="select sum(qty) from invoice_items where date='$today_date' and user_type='$Login_user_TYPEvl'";
...
//Today Total Amount
$select_totalamount_today="select sum(total) from user_invoice where date='$today_date' and from_user_type='$Login_user_TYPEvl'";
...
$select_totalamount_today2="select sum(total) from invoice where date='$today_date' and user_type='$Login_user_TYPEvl'";
...
$select_prqty_yesterday="select sum(qty) from user_invoice_items where date='$Yesterday_date' and from_user_type='$Login_user_TYPEvl'";
...
$select_prqty12_yesterday="select sum(qty) from invoice_items where date='$Yesterday_date' and user_type='$Login_user_TYPEvl'";
...
$select_totalamount_yesterday="select sum(total) from user_invoice where date='$Yesterday_date' and from_user_type='$Login_user_TYPEvl'";
...
$select_totalamount_yesterday2="select sum(total) from invoice where date='$Yesterday_date' and user_type='$Login_user_TYPEvl'";
...
$select_prqty_thismonth="select sum(qty) from user_invoice_items where date between '$start_date' and '$endDate' and from_user_type='$Login_user_TYPEvl'";
...
$select_prqty12_thismonth="select sum(qty) from invoice_items where date between '$start_date' and '$endDate' and user_type='$Login_user_TYPEvl'";
...
$select_totalamount_thismonth="select sum(total) from user_invoice where date between '$start_date' and '$endDate' and from_user_type='$Login_user_TYPEvl'";
...
$select_totalamount_thismonth2="select sum(total) from invoice where date between '$start_date' and '$endDate' and user_type='$Login_user_TYPEvl'";
...
$select_count_invoice_lastmonth="select count(*) as numinvoicetdy from user_invoice where date between '$lastmonth_date' and '$today_date' and from_user_type='$Login_user_TYPEvl' and sub_total>0";
...
$select_count_invoice_lastmonth2="select count(*) as numinvcntcus from invoice where date between '$lastmonth_date' and '$today_date' and user_type='$Login_user_TYPEvl' and sub_total>0";
...
$select_prqty_lastmonth="select sum(qty) from user_invoice_items where date between '$lastmonth_date' and '$today_date' and from_user_type='$Login_user_TYPEvl'";
...
$select_prqty12_lastmonth="select sum(qty) from invoice_items where date between '$lastmonth_date' and '$today_date' and user_type='$Login_user_TYPEvl'";
...
$select_totalamount_lastmonth="select sum(total) from user_invoice where date between '$lastmonth_date' and '$today_date' and from_user_type='$Login_user_TYPEvl'";
...
$select_totalamount_lastmonth2="select sum(total) from invoice where date between '$lastmonth_date' and '$today_date' and user_type='$Login_user_TYPEvl'";
