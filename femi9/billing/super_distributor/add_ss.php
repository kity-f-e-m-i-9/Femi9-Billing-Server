...
<input type="hidden" name="distributor_id" value="<?=$loguser_tempid?>">
...
function getXMLHTTP() { //fuction to return the xml http object
	...
	function getPincode(courseId,scourseID,talukID) {		
		...
		var strURL="find_pincode.php?subcourseID="+courseId+"&techID="+scourseID+"&talukID="+talukID;
		var req = getXMLHTTP();
		if (req) {
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
	...
	<option value="<?php echo $result_LoGuserDtails['state_id'];?>" hidden=""><?php echo $result_LoGuserDtails['state_id'];?></option>
	</select>
	<br/>
	
	<label for="exampleInputEmail1" class="form-label">District Name</label>
    <select name="dist_id" class="form-control">
	<option value="<?php echo $result_LoGuserDtails['district_id'];?>" hidden=""><?php echo $result_LoGuserDtails['district_id'];?></option>
	</select>
	<br/>
	
	<label for="exampleInputEmail1" class="form-label">Taluk Name</label>
    <select name="taluk_id" class="form-control">
	<option value="<?php echo $result_LoGuserDtails['taluk_id'];?>" hidden=""><?php echo $result_LoGuserDtails['taluk_id'];?></option>
	</select>
	<br/>
	
	<label for="exampleInputEmail1" class="form-label">Pincode*</label>
	<input type="text" name="pincode_id" class="form-control" required="" onkeypress="restrictpincode(event)" maxlength="15">
<br/>		
...
var name="10";
xmlhttp.open("GET","loadcoupon.php?q="+str + '&name='+ name,true);
xmlhttp.send();}
</script>
...
var name="10";
xmlhttp.open("GET","loadcouponvalid.php?q="+str + '&name='+ name,true);
xmlhttp.send();}
</script>
            ...
            <div class="form-check">
                <input onclick="showcouopon(this.value)" class="form-check-input" type="radio" name="amount_method" id="gridRadios1" value="phonepe">
