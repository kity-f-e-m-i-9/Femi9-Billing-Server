...
$select_Referaral_dtails="select * from super_distributor_referral where sd_id='$Login_user_IDvl'";
...
$select_StockistCategory="select * from super_distributor_category where amount='$target_amount'";
