...
<head>
    ...
    <!-- Title -->
    <title>Overview Super Stockist : <?php echo $business_name;?></title>
                            ...
                            <div class="col">
                              ...
                              <div style="overflow-x:scroll;">
                                         <table id="datatable1" style="width:100%;">
											...
											<tbody>
				<?php $select_product_list="select * from super_stockiest order by id desc";
...
$district_name=	$result_district['dist_name'];
					...
					<a href="<?=$result_product_list["user_icon"];?>" target="_blank">
					<img src="<?=$result_product_list["user_icon"];?>" style="width:90px;border-radius:10px;">
					</a>
					<?php } ?>
					</td>
