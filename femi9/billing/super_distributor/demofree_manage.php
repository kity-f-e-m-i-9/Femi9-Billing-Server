...
?>
				...
				<?php }?>
											...
											<tbody>
										<?php 
									$select_product_list12="select distinct`tempid` from `demofreedamage` where usertype='$Login_user_TYPEvl' and userid='$Login_user_IDvl'";
...
<a href="demofree_details?tempid=<?=$tempid;?>"><img src="../../assets/images/details-32.png"/></a>
													...
													<td>
<a href="demofree_edit?tempid=<?=$tempid;?>" title="Print">
