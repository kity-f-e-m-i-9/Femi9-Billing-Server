...
// shop-invoice-pdf.php) — opens the TP's own WhatsApp with the shop's
// number and a prefilled message already selected; the TP just taps Send.
...
$__wa_digits = preg_replace('/\D/', '', $shop['mobile_number'] ?? '');
