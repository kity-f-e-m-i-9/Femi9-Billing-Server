...
$qty    = (int)($_POST['qty'] ?? 0);
// Price is a TP-entered override for this line (the shop may be billed at a
// different rate than the product master's MRP) — posted value, falling
// back to the line's existing amount if left blank/invalid.
