...
<head>
    ...
    <!-- Title -->
    <title>Manage Orders (No Orders) : <?php echo $business_name;?></title>
                ...
                <div class="content-wrapper">
                    <div class="container-fluid">
						...
						?>
									...
									<tr>
									<td>Manage Orders <font size="3">(No Orders)</font></td>
									<td>
									<a href="manager_order_pdf2?frd=<?=$from_date;?>&&tod=<?=$to_date;?>" title="Export" target="_blank"><img src="32-pdf.png"></a>
									</td>
									</tr>
									</table>
									</h1>
...
<div id="searchbuttoncont">
<button type="button" onclick="Javascript:window.location='manage_order';" style="margin-left:10px;" class="btn btn-primary"><i class="material-icons"></i>Reset</button>
</div>
...
?>
			...
			<td>
			<a href="edit_order.php?prid=<?php echo $rowid;?>&&actionupdate" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Details">
