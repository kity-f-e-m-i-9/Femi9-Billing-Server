...
<form action="exp_action" method="post" enctype="multipart/form-data" id="uploadForm">
...
return $Hash; } $randum_number=GeraHash(32);
...
<input type="hidden" name="ms_id" value="<?=$markeingSTFID?>">
            ...
            <input type="number" name="amount" min="1" autofocus max="99999" required class="form-control">
			<br/>
			
			<label class="form-label">Bill Copy*</label>
            <input type="file" name="photos" required id="fileUpload" accept=".jpg, .jpeg, .png" class="form-control">
			<br/>

			
			<label class="form-label">Remarks*</label>
            <textarea name="remarks" onkeypress="restrictSpecialChars(event)" class="form-control" required></textarea>
			<br/>
