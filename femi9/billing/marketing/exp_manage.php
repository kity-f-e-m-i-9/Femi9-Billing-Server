...
<head>
    ...
    <!-- Title -->
    <title>Manage Expenses : <?php echo $business_name;?></title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['addedsuccess'])){?><div class="alert alert-success">Expenses details added success.</div><?php }?>
								
								<?php if(isset($_REQUEST['updatedSuccess'])){?><div class="alert alert-info">Changes saved success.</div><?php }?>
								
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! One Expenses Details Deleted Success.</div><?php }?>
						...
						?>
									...
									<td><a href="exp_add.php" title="Add Expenses">&#10011;</a></td>
									
									<td>
									<a href="exp_pdf?frd=<?=$from_date;?>&&tod=<?=$to_date;?>" title="Export" target="_blank"><img src="32-pdf.png"></a>
									</td>
...
<div id="searchbuttoncont">
<button type="button" onclick="Javascript:window.location='exp_manage';" style="margin-left:10px;" class="btn btn-primary"><i class="material-icons"></i>Reset</button>
</div>
...
?>                                            
			...
			<td>
			<a href="exp_edit.php?prid=<?php echo $rowid;?>&&actionupdate" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Details">
