...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['subforgotbutton'])) {
    ...
    if (!checkRateLimit($rateLimitKey, 5, 3600)) {
        ...
        try {
            ...
            // Configuration
            $userTable = 'marketing_staff';
            $userType = 'marketing';
            
            // Fetch user
            $stmt = mysqli_prepare($db_conn, 
                "SELECT id, ms_name, ms_email, ms_mobile FROM {$userTable} WHERE ms_mobile = ? LIMIT 1"
            );
            ...
            try {
                ...
                $updateStmt = mysqli_prepare($db_conn, 
                    "UPDATE {$userTable} SET password = ? WHERE ms_mobile = ?"
                );
...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">Forgot Password : Marketing</p>
