...
if (!empty($ids)) {
    ...
    $resNames = $db_conn->query("SELECT ms_name FROM marketing_staff WHERE id IN ($idList)");
    if ($resNames) {
...
<head>
    ...
    <style>
        ...
        .mt-page-card { background:#fff; border:1px solid #e5e7eb; border-radius:10px; box-shadow:0 1px 2px rgba(11,11,11,0.03); }
