...
<select name="shop_cat" class="form-control">
	...
	<input type="text" name="pincode" value="<?php echo $result_product_list['pincode'];?>" class="form-control" required="" onkeypress="restrictpincode(event)" maxlength="15">
<br/>	
...
<?php }?>
	...
	<label class="form-label">Google Location (URL)</label>
            <textarea name="google_location" onkeypress="restrictSpecialChars(event)" class="form-control"><?=$result_product_list['google_location'];?></textarea>
			<br/>
