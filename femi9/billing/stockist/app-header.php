...
$Average_available_walletAmount_ST=$Total_wallet_amount_ST-$Total_withdraw_amount_ST;
								?>
								 ...
								 <li class="nav-item st-account-toggle">
                                    <style>
                                        ...
                                        @media (max-width: 1100px) {
                                            .st-account-toggle { display: flex !important; }
                                            .st-account-toggle .nav-notifications-toggle { padding: 2px !important; }
                                            .st-account-toggle .nav-notifications-toggle img { width: 52px; height: 52px; object-fit: cover; border-radius: 50%; }
                                        }
                                        @media (max-width: 400px) {
                                            .st-account-toggle .nav-notifications-toggle img { width: 48px; height: 48px; }
                                        }
                                        @media (max-width: 991px) {
                                            .notifications-dropdown.st-account-dropdown {
                                            ...
                                            .notifications-dropdown.st-account-dropdown:not(.show) { display: none !important; }
                                            .notifications-dropdown.st-account-dropdown.show { display: block !important; }
                                        }
                                    </style>
                                    <a class="nav-link nav-notifications-toggle" id="notificationsDropDown" href="#"><img src="../../assets/images/femi-logo.png"/></a>
                                    <div class="dropdown-menu dropdown-menu-end notifications-dropdown st-account-dropdown" aria-labelledby="notificationsDropDown">
			...
			(function () {
			    ...
			    var menu = toggle ? toggle.closest('.nav-item').querySelector('.st-account-dropdown') : null;
