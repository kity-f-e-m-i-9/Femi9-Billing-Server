...
$select_UserdETAILS="select * from stockiest where temp_id='$Login_user_IDvl'";
...
<?php $selecthsn="select distinct hsn from user_invoice_items where inv_id='$Invoice_ID' and gst_percentage>0";
