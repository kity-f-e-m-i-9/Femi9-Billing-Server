		   ...
		   if($result_LoGuserDtails['onboard_userTYPE']=="company"){?>
						<h1>Company</h1>
							...
							<?php }else if($result_LoGuserDtails['onboard_userTYPE']=="super_stockiest"){
								...
								$acman_ID=$result_LoGuserDtails['ss_id'];
...
?>
							...
							<h1><?=ucwords($result_StockDetails['name']);?>
							<span style="font-size:12px;">(Super Stockist)</span>
							</h1>
<h2><?=ucwords($district_name)?></h2>
...
<?php }?>
		...
		<?php }  else{
			...
			if($result_RFRDtailsCNG['st_ref_type']=="super_stockiest"){
		$tblename="super_stockiest";
		$labelname="Super Stockist";
		}
		else if($result_RFRDtailsCNG['st_ref_type']=="stockiest"){
			$tblename="stockiest";
			$labelname="Stockist";
		}
		else if($result_RFRDtailsCNG['st_ref_type']=="super_distributor"){
		...
		$select_count_REFERID="select * from ".$tblename." where useridtext='".$result_RFRDtailsCNG['st_ref_userid']."'";
