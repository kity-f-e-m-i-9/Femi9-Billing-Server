...
<form action="ss-action.php" method="post" enctype="multipart/form-data" id="uploadForm">
...
<input type="hidden" name="password" value="12345678">
            ...
            <input type="text" required="" name="name" autofocus class="form-control" onkeypress="restrictSpecialChars(event)">
	...
	<option value="<?php echo $result_stcatlist['amount'];?>"><?php echo $result_stcatlist['amount'];?></option>
            ...
            <input type="file" name="user_icon" required="" id="fileUpload" accept=".jpg, .jpeg, .png" class="form-control">
<br/>
...
xmlhttp.send();}
        ...
        <!-- New add end -->
            ...
            <textarea name="address" onkeypress="restrictSpecialChars(event)" class="form-control" required="required"></textarea>
			<br/>
			
			<label class="form-label">GST Number*</label>
            <input type="text" required="" onkeypress="restrictGSTIN(event)" name="gstin" class="form-control">
			<br/>
