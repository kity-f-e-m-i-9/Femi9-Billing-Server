                        ...
                        <div class="row">
                            <div class="col-md-12">
								...
								<h1>
									...
									<tr>
									<td><?=$displaytitle;?></td>
									<td><a href="stock_request_pending.php" title="Manage Request">&#9776;</a></td>
									</tr>
									</table>
									</h1>
...
<form action="user-invoice-action-req.php" method="post" enctype="multipart/form-data">
...
<input type="hidden" name="godownid" value="<?=$Login_user_IDvl?>">
...
<form action="invoice-submit-req.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
...
<?php $_SESSION['INVOICEFINISH']="1";?>
			...
			<input type="number" min="0" step="any" value="<?=number_format($TotalAMount123,2,'.','');?>" id="subtotal" disabled></span>
			</p>
			<br/>
		...
		<p class="bold">Round off <span>
		 <input type="number" min="0" step="any" value="<?=number_format($roundoff,2,'.','');?>" disabled>
		 </span>
		 </p><br/>
		 
		 <p class="bold">Courier Charges <span>
		 <input type="number" value="<?=$result_InvoieDetails['courier_charges'];?>" name="courier_charges" min="0" required="" onKeyup="totalamount()" id="cucharge">
		 </span>
		 </p><br/>
		 
		 <p class="bold">Total <span>
		 <input type="number" min="0" step="any" value="<?=number_format($roundvalue,2,'.','');?>" id="outputTotalamount" disabled>
		 </span>
		 </p><br/>
  ...
  function receiptamount(){
   ...
   document.getElementById('receivableamount').value = (totalbillamount*1)-(receivedamount*1); 
		 ...
		 <p class="bold">Received Amount<span>
		 <input type="number" min="0" step="any" required="" id="receivedamount" onkeyup="receiptamount()" name="receivedamount">
		 </span>
		 </p>
		 <br/>
		 
		 <p class="bold">Receivable Amount<span>
		 <input type="number" min="0" id="receivableamount" readonly value="0">
		 </span>
		 <span id="error" style="color: red; display: none;font-size:12px;">Value must be non-negative.</span>
		 </p>
		 <br/>
		 
		 <p class="bold">Received Method<span>
...
<p class="bold">Remarks<span>
		 <textarea name="receipt_remarks" required></textarea>
		 </span>
		 </p>
		 <br/>
