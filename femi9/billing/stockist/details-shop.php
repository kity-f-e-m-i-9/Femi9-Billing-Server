                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
									...
									<tr>
									<td>Details : Shop</td>
									<td><a href="Shop-manage.php">&#9776;</a></td>
									</tr>
									</table>
									</h1>
                                </div>
                        ...
                        <div class="row">
                            <div class="col">
							 ...
							 <tr><td style="font-size:18px;"><b><?=$result_product_list['name'];?></td></tr>
							 
							 <tr><td>Shop Address</td></tr>
							 <tr><td style="font-size:18px;"><b><?=strtoupper($result_product_list['address']);?></td></tr>
							 
							 <tr><td>Email ID</td></tr>
							 <tr><td style="font-size:18px;"><b><?=$result_product_list['email'];?></td></tr>
							 
							 <tr><td>GSTIN</td></tr>
							 <tr><td style="font-size:18px;"><b><?=$result_product_list['gstin'];?>
							 <hr/>
							 </td></tr>
							 
							 <tr><td  colspan="2"><h1>Last Invoice Details</h1></td></tr>
							 ...
							 <tr><td style="font-size:18px;"><b><?=$inv_number;?></b>
							 <hr/>
							 </td></tr>
							 ...
							 <tr>
							 <td style="font-size:18px;"><b><?=date("d/M/Y",strtotime($invdate));?></b>
							 </td></tr>
							 <?php }?>
