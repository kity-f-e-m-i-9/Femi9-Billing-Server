                        ...
                        <div class="row">
                            <div class="col-md-12">
								...
								<h1>
									...
									<tr>
									<td><?=$displaytitle;?></td>
									<td><a href="stock_request_billed.php" title="Manage Request">&#9776;</a></td>
									</tr>
									</table>
									</h1>
...
$(document).ready(function(){
    ...
    $('.popup-trigger').click(function(){
        ...
        $('#popup-content').html("<p>Product Name : <b>" + rowData[0] + "</b></p><p>Qty : <b>" + rowData[1] + "</b></p><p>Amount : <b>" + rowData[2] + "</b></p><p>Total : <b>" + rowData[3] + "</b></p>");
