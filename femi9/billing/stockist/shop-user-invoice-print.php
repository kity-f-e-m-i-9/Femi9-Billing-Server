...
<br/>
<button type="button" onClick="javascript:window.location='shop-user-manage-invoice.php?invuser=<?=$getinvuser;?>';" class="btn btn-primary m-b-xs m-r-xs" id="butonwidth">Manage Invoice</button>
