...
<div class="alert alert-danger">This Customer already exists.</div>
<?php } ?>
                            ...
                            <div class="col-md-12">
                                <div class="card">
									...
									<table id="receipttble" style="width:100%;">
											...
											<tbody>
					<?php $select_product_list="select * from invoice where inv_id='$invid'";
				...
				<form action="update_customer_action3.php" method="post" enctype="multipart/form-data" onsubmit="return confirm('Please make a confirm!')">
...
<select required="" name="new_customer_id" class="js-states form-control" tabindex="-1" style="display: none; width: 100%">
<option value="" hidden="">Select</option>
<?php 
$selectCusList="select * from customers where user_type='$onboard_userTYPE' and user_id='$onboard_userID' order by name asc";
...
while($result_Customers_list=mysqli_fetch_array($fetch_Customers_list))
		{
			...
			$UserName_SHOW="".strtoupper($result_Customers_list['name']).", ".$result_Customers_list['mobile']."";	
			
			
?>
<option value="<?=$result_Customers_list['id'];?>"><?=$UserName_SHOW;?></option>
<?php }?>
</select>
