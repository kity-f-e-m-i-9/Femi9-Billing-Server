                        ...
                        <div class="row">
                            <div class="col">
								...
								<?php if(isset($_REQUEST['deletedDone'])){?><div class="alert alert-warning">Deleted ! one Invoice details deleted success.</div><?php }?>
									...
									<td><a href="export_user_invoice.php?invuser=<?=$getinvuser;?>" title="Export"><img src="../../assets/images/excel-3-32.png"></a></td>
									</tr>
									</table>
									</h1>
                                </div>
...
?>
			...
			<!----------END CUSTOMER UPDATE***--------->
				...
				<td><?php $discount=$result_product_list["discount"]+$result_product_list["credit"];
