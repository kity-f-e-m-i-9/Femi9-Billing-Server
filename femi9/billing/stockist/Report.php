           ...
           <?php include("app-header.php");?>
            ...
            <div class="app-content">
				...
				<?php include("report_onboarded.php"); ?>
						...
						<a href="overview_outstanding?modelval=usr3&&out1=<?=base64_encode($Total_OUTST_VLDIST_Show)?>" style="text-decoration:none;">
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Distributors</span>
                                                <span class="widget-stats-amount"><?=$Total_OUTST_VLDIST_Show;?></span>
                                            </div>
											</a>
                                        </div>
                                    </div>
