                                ...
                                <div class="card">
									...
									<div id="overflowon">
                                        <table id="datatable1" class="display" style="width:100%;">
											...
											<tbody>
										<?php $select_product_list="select * from user_invoice where from_user_id='$Login_user_IDvl' and to_user_type='$getinvuser' order by id desc";
...
<?php }?>
													...
													<td>
<a href="shop-user-invoice-add.php?invuser=<?=$getinvuser;?>&&action=edit&&InvoiceID=<?php echo $INVID_encode;?>" title="Edit"><img src="../../assets/images/edit-32.png"/></a>
													</td>
