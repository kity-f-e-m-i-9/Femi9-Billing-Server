...
fputcsv($output, ['Name', 'State', 'District', 'Taluk', 'Pincode', 'Mobile Number', 'Email ID', 'Address']);

$select_product_list = "select * from shop where onboard_userID='$onboard_userID' order by id desc";
