...
$select_product_list = "select s.*, sc.catlable from shop s LEFT JOIN shop_category sc ON s.shop_cat = sc.id where s.onboard_userID='$onboard_userID' order by s.id desc";
