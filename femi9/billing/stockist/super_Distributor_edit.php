...
$manage_url="super_Distributor_manage";
$manage_title="Manage Super-Distributor";
$message_title="Super-Distributor";
//
...
$select_product_list="select * from super_distributor where id='$get_id'";
				...
				$super_distributor_temp_id=$result_product_list['temp_id'];
				//
				$select_referral_records="select * from super_distributor_referral where sd_id='$super_distributor_temp_id'";
...
<form action="super_Distributor_edit_action" method="post" enctype="multipart/form-data">
...
<input type="hidden" name="sd_id" value="<?=$result_product_list['temp_id'];?>">
           ...
           <select required="" name="target_amount" class="form-control">
							   ...
							   <?php $select_stcatlist="select * from super_distributor_category order by id asc";
	...
	<option value="<?php echo $result_stcatlist['amount'];?>"><?php echo $result_stcatlist['amount'];?></option>
            ...
            <input type="file" name="user_icon" value="<?php echo $imgsrcname;?>" accept=".jpg, .jpeg, .png" class="form-control">
			<br/>
			<?php
			if($result_product_list["user_icon"]!="Nil"){$imgsrcname="../super_distributor/".$result_product_list["user_icon"]."";}else{$imgsrcname="../../assets/images/no image.jpg";}
			?>
			<img src="<?php echo $imgsrcname;?>" style="width:100px;"/><br/>									
...
<?php }?>
            ...
            <div class="mobile-number">
                ...
                <input type="text" required onkeypress="restrictnumber(event)" pattern="[1-9]{1}[0-9]{9}" value="<?php echo $result_product_list['mobile_number'];?>" class="form-control" maxlength="10" disabled>
            </div>
        </div>
        <!-- New add end -->
