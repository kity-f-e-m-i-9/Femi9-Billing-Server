...
$selectRcd_VLSS1="select * from temp_not_purchased where purchse_count='0' and usertype='super_stockiest' and onboard_userTYPE='$Login_user_TYPEvl' and onboard_userID='$Login_user_IDvl'";
