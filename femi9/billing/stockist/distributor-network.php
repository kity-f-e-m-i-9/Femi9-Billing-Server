...
<tr><td colspan="4"><a href="shop-network.php?stockistid=<?=$stockistid;?>&&distributorid=<?=$result_product_list['temp_id'];?>" title="<?php echo strtoupper($result_product_list["name"]);?>"><div class="bottom-arrow"></div></a><br/></td></tr>
</tbody>
