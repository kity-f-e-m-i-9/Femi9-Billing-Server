...
<table id="datatable1">
											...
											<tbody>
<?php
$select_product_list="select * from demo_awareness where stockist_id='$Login_user_IDvl' order by date desc";
...
if($usertype=="distributor"){ $tablename="distributor"; $photourl="distributor"; $disusertype="Distributor";}
