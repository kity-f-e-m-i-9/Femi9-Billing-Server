...
<input type="hidden" name="update_id" value="<?php echo $result_product_list["id"]?>">
                                        ...
                                        <div class="example-container">
                                            <div class="example-content">
                                                ...
                                                <input type="text" required="" name="productName" value="<?php echo $result_product_list["productName"]?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
