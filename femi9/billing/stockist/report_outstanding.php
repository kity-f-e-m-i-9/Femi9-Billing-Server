...
if($Total_OUTST_VLSTK!=NULL){
	$Total_OUTST_VLSTK_Show=inr_format($Total_OUTST_VLSTK, 2);}
...
if($Total_OUTST_VLDIST!=NULL){
	$Total_OUTST_VLDIST_Show=inr_format($Total_OUTST_VLDIST, 2);}
...
if($Total_OUTST_VLSHOP!=NULL){
	$Total_OUTST_VLSHOP_Show=inr_format($Total_OUTST_VLSHOP, 2);}
